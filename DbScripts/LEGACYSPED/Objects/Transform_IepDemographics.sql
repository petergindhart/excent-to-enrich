...
AS
	...
	FROM
		...
		LEGACYSPED.Transform_School ss on s.ServiceSchoolCode = ss.SchoolCode /* and ss.DeletedDate is null */ LEFT JOIN
		LEGACYSPED.Transform_School sh on s.HomeSchoolCode = sh.SchoolCode /* and sh.DeletedDate is null */ LEFT JOIN
