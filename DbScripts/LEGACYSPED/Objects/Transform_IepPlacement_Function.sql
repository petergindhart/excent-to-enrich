...
insert @p
	...
	FROM dbo.IepPlacementType pt CROSS JOIN
		@Transform_IepLeastRestrictiveEnvironment lre LEFT JOIN 
		...
		dbo.IepPlacement t on isnull(lre.DestID,'00000000-0000-0000-0000-000000000000') = isnull(t.ID,'FFFFFFFF-FFFF-FFFF-FFFF-FFFFFFFFFFFF')  LEFT JOIN  
