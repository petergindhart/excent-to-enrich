...
as
select s.ServiceRefId, s.IepRefId, m.DestID, s.DefId, s.InstanceID, s.StudentID, s.StartDate, s.EndDate, s.Amount, s.FrequencyId, s.UnitID, s.ProviderTitleID, s.Sequence, s.ServiceTypeID, s.CategoryCode, s.CategoryID, s.DirectID, s.ExcludesID, s.EsyID, s.DeliveryStatement , CAST ( 0 AS BIT) as UseAmountRange
