...
-- select * from OrgUnit where Street is not null
...
insert @importPrgSections values (1, 'IEP Services', '9AC79680-7989-4CC9-8116-1CCDB1D0AE5F') -- Durango has opted not to import converted data services
...
-- Littleton
--ServFreq||3D4B557B-0C2E-4A41-9410-BA331F1D20DD||Per Month|monthly
--ServFreq||A2080478-1A03-4928-905B-ED25DEC259E6||Per Week|weekly
