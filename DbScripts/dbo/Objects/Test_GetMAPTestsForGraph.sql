...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[Test_GetMAPTestsForGraph]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[Test_GetMAPTestsForGraph]
GO
...
*/
CREATE PROCEDURE dbo.Test_GetMAPTestsForGraph
