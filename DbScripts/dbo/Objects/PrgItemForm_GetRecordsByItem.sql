if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[PrgItemForm_GetRecordsByItem]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[PrgItemForm_GetRecordsByItem]
GO
...
*/
CREATE PROCEDURE [dbo].[PrgItemForm_GetRecordsByItem]
