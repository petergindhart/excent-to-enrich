...
EXEC xp_cmdshell @sql
set @sql = 'bcp "select tablename+'' - ''+errormessage +'' - ''+ convert(varchar(10),LineNumber)+''- "''+Line+''" '' from '+@dbname+'.Datavalidation.Validationreport WHERE TableName= ''School'' order by CONVERT(int,LineNumber)" queryout "'+@reportpath+'\ValidationReport_School.txt"  -T -c -t,' 
EXEC xp_cmdshell @sql
set @sql = 'bcp "select tablename+'' - ''+errormessage +'' - ''+ convert(varchar(10),LineNumber)+''- "''+Line+''" '' from '+@dbname+'.Datavalidation.Validationreport WHERE TableName= ''Student'' order by CONVERT(int,LineNumber)" queryout "'+@reportpath+'\ValidationReport_Student.txt"  -T -c -t,' 
EXEC xp_cmdshell @sql
SET @sql = 'bcp "select tablename+'' - ''+errormessage +'' - ''+ convert(varchar(10),LineNumber)+''- "''+Line+''" '' from '+@dbname+'.Datavalidation.Validationreport WHERE TableName= ''IEP'' order by CONVERT(int,LineNumber)" queryout "'+@reportpath+'\ValidationReport_IEP.txt"  -T -c -t,' 
EXEC xp_cmdshell @sql
SET @sql = 'bcp "select tablename+'' - ''+errormessage +'' - ''+ convert(varchar(10),LineNumber)+''- "''+Line+''" '' from '+@dbname+'.Datavalidation.Validationreport WHERE TableName= ''SpedStaffMember'' order by CONVERT(int,LineNumber)" queryout "'+@reportpath+'\ValidationReport_SPEDSTAFFMEMBER.txt"  -T -c -t,' 
EXEC xp_cmdshell @sql
SET @sql = 'bcp "select tablename+'' - ''+errormessage +'' - ''+ convert(varchar(10),LineNumber)+''- "''+Line+''" '' from '+@dbname+'.Datavalidation.Validationreport WHERE TableName= ''Service'' order by CONVERT(int,LineNumber)" queryout "'+@reportpath+'\ValidationReport_Service.txt"  -T -c -t,' 
EXEC xp_cmdshell @sql
SET @sql = 'bcp "select tablename+'' - ''+errormessage +'' - ''+ convert(varchar(10),LineNumber)+''- "''+Line+''" '' from '+@dbname+'.Datavalidation.Validationreport WHERE TableName= ''Goal'' order by CONVERT(int,LineNumber)" queryout "'+@reportpath+'\ValidationReport_Goal.txt"  -T -c -t,' 
EXEC xp_cmdshell @sql
