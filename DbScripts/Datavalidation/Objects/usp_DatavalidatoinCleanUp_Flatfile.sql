IF EXISTS (SELECT 1 FROM sys.schemas s join sys.objects o on s.schema_id = o.schema_id where s.name = 'Datavalidation' and o.name = 'Cleanup_Flatfile')
DROP PROC Datavalidation.Cleanup_Flatfile
GO

CREATE PROC Datavalidation.Cleanup_Flatfile 
AS
BEGIN
