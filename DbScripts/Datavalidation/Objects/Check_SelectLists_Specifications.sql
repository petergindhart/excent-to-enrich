...
WHERE ((DATALENGTH(sl.TYPE)/2)<=20) 
		  ...
		  AND sl.EnrichLabel NOT IN ( SELECT EnrichLabel FROM Datavalidation.Selectlists_LOCAL WHERE Type IN ('Ethnic','Grade','Gender','Disab','Exit','ServLoc','ServProv','ServFreq','GoalArea','PostSchArea') GROUP BY TYPE,EnrichLabel Having COUNT(*)>1)
		  AND sl.EnrichLabel NOT IN ( SELECT EnrichLabel FROM Datavalidation.Selectlists_LOCAL WHERE Type IN ('LRE','Service') GROUP BY TYPE,SubType,EnrichLabel Having COUNT(*)>1)
...
JOIN (SELECT TYPE,ENRICHLABEL FROM Datavalidation.Selectlists_LOCAL WHERE TYPE = 'Ethnic' GROUP BY TYPE,LEGACYSPEDCODE,ENRICHLABEL HAVING COUNT(*)>1) uceth ON ISNULL(uceth.TYPE,'x') = ISNULL(tsl.TYPE,'y')  AND ISNULL(uceth.ENRICHLABEL,'a') = ISNULL(tsl.EnrichLabel,'s')
...
FROM Datavalidation.Selectlists_LOCAL tsl
JOIN (SELECT TYPE,ENRICHLABEL FROM Datavalidation.Selectlists_LOCAL WHERE TYPE = 'Gender' GROUP BY TYPE,LEGACYSPEDCODE,ENRICHLABEL HAVING COUNT(*)>1) ucgen ON ISNULL(ucgen.TYPE,'x') = ISNULL(tsl.TYPE,'y') AND ISNULL(ucgen.ENRICHLABEL,'a') = ISNULL(tsl.EnrichLabel,'s')
...
FROM Datavalidation.Selectlists_LOCAL tsl
JOIN (SELECT TYPE,ENRICHLABEL FROM Datavalidation.Selectlists_LOCAL WHERE TYPE = 'Grade' GROUP BY TYPE,LEGACYSPEDCODE,ENRICHLABEL HAVING COUNT(*)>1) ucgrad ON ISNULL(ucgrad.TYPE,'x') = ISNULL(tsl.TYPE,'y') AND ISNULL(ucgrad.ENRICHLABEL,'a') = ISNULL(tsl.EnrichLabel,'s')
...
FROM Datavalidation.Selectlists_LOCAL tsl
JOIN (SELECT TYPE,ENRICHLABEL FROM Datavalidation.Selectlists_LOCAL WHERE TYPE = 'Disab' GROUP BY TYPE,LEGACYSPEDCODE,ENRICHLABEL HAVING COUNT(*)>1) ucdisab ON ISNULL(ucdisab.TYPE,'x') = ISNULL(tsl.TYPE,'y') AND ISNULL(ucdisab.ENRICHLABEL,'a') = ISNULL(tsl.EnrichLabel,'s')
...
FROM Datavalidation.Selectlists_LOCAL tsl
JOIN (SELECT TYPE,ENRICHLABEL FROM Datavalidation.Selectlists_LOCAL WHERE TYPE = 'Exit' GROUP BY TYPE,LEGACYSPEDCODE,ENRICHLABEL HAVING COUNT(*)>1) ucex ON ISNULL(ucex.TYPE,'x') = ISNULL(tsl.TYPE,'y') AND ISNULL(ucex.ENRICHLABEL,'a') = ISNULL(tsl.EnrichLabel,'s')
/*
INSERT Datavalidation.ValidationSummaryReport (TableName,ErrorMessage,NumberOfRecords)
...
FROM Datavalidation.Selectlists_LOCAL tsl
JOIN (SELECT TYPE,ENRICHLABEL FROM Datavalidation.Selectlists_LOCAL WHERE TYPE = 'ServLoc' GROUP BY TYPE,LEGACYSPEDCODE,ENRICHLABEL HAVING COUNT(*)>1) ucserloc ON ISNULL(ucserloc.TYPE,'x') = ISNULL(tsl.TYPE,'y')  AND ISNULL(ucserloc.ENRICHLABEL,'a') = ISNULL(tsl.EnrichLabel,'s')
...
FROM Datavalidation.Selectlists_LOCAL tsl
JOIN (SELECT TYPE,ENRICHLABEL FROM Datavalidation.Selectlists_LOCAL WHERE TYPE = 'ServProv' GROUP BY TYPE,LEGACYSPEDCODE,ENRICHLABEL HAVING COUNT(*)>1) ucserprov ON ISNULL(ucserprov.TYPE,'x') = ISNULL(tsl.TYPE,'y') AND ISNULL(ucserprov.ENRICHLABEL,'a') = ISNULL(tsl.EnrichLabel,'s')
...
FROM Datavalidation.Selectlists_LOCAL tsl
JOIN (SELECT TYPE,ENRICHLABEL FROM Datavalidation.Selectlists_LOCAL WHERE TYPE = 'ServFreq' GROUP BY TYPE,LEGACYSPEDCODE,ENRICHLABEL HAVING COUNT(*)>1) ucserfreq ON ISNULL(ucserfreq.TYPE,'x') = ISNULL(tsl.TYPE,'y') AND ISNULL(ucserfreq.ENRICHLABEL,'a') = ISNULL(tsl.EnrichLabel,'s')
/*
INSERT Datavalidation.ValidationSummaryReport (TableName,ErrorMessage,NumberOfRecords)
...
FROM Datavalidation.Selectlists_LOCAL tsl
JOIN (SELECT TYPE,ENRICHLABEL FROM Datavalidation.Selectlists_LOCAL WHERE TYPE = 'GoalArea' GROUP BY TYPE,LEGACYSPEDCODE,ENRICHLABEL HAVING COUNT(*)>1) ucgoal ON ISNULL(ucgoal.TYPE,'x') = ISNULL(tsl.TYPE,'y') AND ISNULL(ucgoal.ENRICHLABEL,'a') = ISNULL(tsl.EnrichLabel,'s')
/*
INSERT Datavalidation.ValidationSummaryReport (TableName,ErrorMessage,NumberOfRecords)
