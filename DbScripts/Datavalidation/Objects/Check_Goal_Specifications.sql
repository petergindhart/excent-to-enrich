...
SELECT ''Goal'',''The field '+@columnname+' is required field.'',Line_No,ISNULL(CONVERT(VARCHAR(max),GoalRefID),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),IepRefID),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),Sequence),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),GoalAreaCode),'''')+ISNULL(CONVERT(VARCHAR(max),PSEducation),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),PSEmployment),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),PSIndependent),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),IsEsy),'''')+ISNULL(CONVERT(VARCHAR(max),UNITOFMEASUREMENT),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),BASELINEDATAPOINT),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),EVALUATIONMETHOD),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),GoalStatement),'''') FROM Datavalidation.Goal_Local WHERE 1 = 1'
...
SET @vsql = 'INSERT Datavalidation.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT ''Goal'',''The date format issue is in '+@columnname+'.'',Line_No,ISNULL(CONVERT(VARCHAR(max),GoalRefID),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),IepRefID),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),Sequence),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),GoalAreaCode),'''')+ISNULL(CONVERT(VARCHAR(max),PSEducation),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),PSEmployment),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),PSIndependent),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),IsEsy),'''')+ISNULL(CONVERT(VARCHAR(max),UNITOFMEASUREMENT),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),BASELINEDATAPOINT),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),EVALUATIONMETHOD),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),GoalStatement),'''') FROM Datavalidation.Goal_Local WHERE 1 = 1 '
...
SET @vsql = 'INSERT Datavalidation.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT ''Goal'',''The field '+@columnname+' should have integer records.'',Line_No,ISNULL(CONVERT(VARCHAR(max),GoalRefID),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),IepRefID),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),Sequence),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),GoalAreaCode),'''')+ISNULL(CONVERT(VARCHAR(max),PSEducation),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),PSEmployment),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),PSIndependent),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),IsEsy),'''')+ISNULL(CONVERT(VARCHAR(max),UNITOFMEASUREMENT),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),BASELINEDATAPOINT),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),EVALUATIONMETHOD),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),GoalStatement),'''') FROM Datavalidation.Goal_LOCAL WHERE 1 = 1 '
