...
-- #############################################################################
-- OrgUnit
IF NOT EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'AURORAX.MAP_OrgUnitID') AND OBJECTPROPERTY(id, N'IsUserTable') = 1)
BEGIN
CREATE TABLE AURORAX.MAP_OrgUnitID
	(
	DistrictRefID nvarchar(150) NOT NULL,
	DestID uniqueidentifier NOT NULL
	)

ALTER TABLE AURORAX.MAP_OrgUnitID ADD CONSTRAINT
...
AAD80F07-6023-4753-AF26-309FF6BF845C	0	0	AURORAX.Transform_OrgUnit	OrgUnit	1	AURORAX.MAP_OrgUnitID	DistrictRefID	NULL	0	0	1	NULL	NULL	NULL	2011-08-31 08:18:16.360	NULL	29D14961-928D-4BEE-9025-238496D144C6	1	0	0
...
FROM  OrgUnit d JOIN 
	AURORAX.Transform_OrgUnit  s ON s.DestID=d.ID
...
-- INSERT AURORAX.MAP_OrgUnitID
SELECT DistrictRefID, NEWID()
FROM AURORAX.Transform_OrgUnit s
