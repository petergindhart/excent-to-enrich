...
insert @IepDisability  (ID, Name, Definition, DeterminationFormTemplateID, StateCode) values  ('B27183DB-F4DC-40B6-943F-785795D5AED5','Does not qualify for Special Education Services',NULL,NULL,NULL)
...
insert @IepDisability  (ID, Name, Definition, DeterminationFormTemplateID, StateCode) values  ('36032F6B-C23D-4B24-BA1A-82C29D6B0D9F','Hearing Impairment','<b>Definition:</b> Hearing impairment means an impairment in hearing, whether permanent or fluctuating, that adversely affects a child’s educational performance but that is not included under the definition of deafness.','9411DB74-237D-4858-B573-1626AE232675','02')
insert @IepDisability  (ID, Name, Definition, DeterminationFormTemplateID, StateCode) values  ('E9CD7BC7-E84F-4D27-B4E3-F11882173AF2','Intellectual Disability','<b>Definition:</b> Intellectual Disability means significantly subaverage general intellectual functioning, existing concurrently with deficits in adaptive behavior and manifested during the developmental period, that adversely affects a child’s educational performance.','73783E65-D10C-42D9-9096-B413F4CC17DA','01')
