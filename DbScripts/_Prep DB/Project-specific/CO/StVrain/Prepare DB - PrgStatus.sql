...
----insert @MAP_PrgStatus (KeepID, TossID) values ('BF898F66-AD71-451F-AD11-3639155A431F', '') -- 'Reached Maximum Age For Services')
----insert @MAP_PrgStatus (KeepID, TossID) values ('4878A47C-1AAA-4697-BE30-42106F214E7D', '') -- 'Death')
----insert @MAP_PrgStatus (KeepID, TossID) values ('C425DBDE-4DBD-4A9D-B1F5-6C3D99262AFD', '') -- 'PK-6 Student Exited, not known to continue')
----insert @MAP_PrgStatus (KeepID, TossID) values ('C2DF5F3F-D0EE-4493-BBA7-6D8327EA36D8', '') -- 'Transferred to Regular Education')
...
----insert @MAP_PrgStatus (KeepID, TossID) values ('05F914D8-2A29-489A-82ED-A7506341A83F', '') -- 'Transfer to a School in a Different State/Country')
----insert @MAP_PrgStatus (KeepID, TossID) values ('DFBE9247-8EBC-447B-87C2-A8FAEB37A96D', '') -- 'Transfer to a Non-Public School')
----insert @MAP_PrgStatus (KeepID, TossID) values ('3C35632F-8323-4CB7-8585-B7D3D4586152', '') -- 'Transfer to Home-Based Education')
----insert @MAP_PrgStatus (KeepID, TossID) values ('2D966F92-A821-47EF-B785-DE1E32C84C3A', '') -- 'Transfer to a Career and Technical Education Program (Non-CO district or BOCES operated)')
----insert @MAP_PrgStatus (KeepID, TossID) values ('BB19EFF0-AF1F-4F8A-A8F2-EC11F2A56711', '') -- 'Transfer to a Facility Operated by CO Dept of Youth Corrections')
----insert @MAP_PrgStatus (KeepID, TossID) values ('E8959582-644B-4AAC-B3FF-0580B1BE158F', '') -- 'Discontinued Schooling / Dropped out')
----insert @MAP_PrgStatus (KeepID, TossID) values ('59BBBBE9-BF7C-44E0-B9FB-0E376A26E0B8', '') -- 'Explusion')
----insert @MAP_PrgStatus (KeepID, TossID) values ('A24AEA49-735D-425F-B803-168769054306', '') -- 'Parent Revokes Consent for Services')
----insert @MAP_PrgStatus (KeepID, TossID) values ('825305B4-0600-4098-8B17-381499942419', '') -- 'GED Transfer')
