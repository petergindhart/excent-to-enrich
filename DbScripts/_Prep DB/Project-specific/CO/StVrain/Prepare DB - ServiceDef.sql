...
insert @MAP_ServiceDef values ('52AD0E2D-3A97-499A-95F4-5B4BB02912DF', '960CD7D5-1A53-4455-A453-5CD8C385491B') -- 'Adapted Physical Education')
insert @MAP_ServiceDef values ('6C1EA4EC-C0F0-4C7D-99F2-7AFBB2DBB68C', '646FC62A-4E37-4ECC-A3F0-D3329682F145') -- 'Audiology Services')
	--insert @MAP_ServiceDef values ('61D1B5E8-C054-4EA8-B9CB-F61EBDB1F629', '54AD7B8C-D44B-45C2-9C80-7BBF87579AB4') -- 'Consultation')
insert @MAP_ServiceDef values ('94C0C353-6595-4A7E-873E-CE77A52474FA', 'CD96747D-3D67-4207-86FD-FD754A498102') -- 'Counseling')
insert @MAP_ServiceDef values ('E3A7E8E5-72C4-4871-8381-E081EC81D1D6', 'F71E1EB1-1322-4AA4-9267-F8039F888D74') -- 'Interpreting Services')
--insert @MAP_ServiceDef values ('B874A136-2F0E-4955-AA1E-1F0D45F263FB', '') -- 'Occupational Therapy')
insert @MAP_ServiceDef values ('CABB2C1E-BC93-4D52-9E2D-AF52A259AD17', '5FE42E82-E76D-462C-B29E-4A9366BBB8C4') -- 'Orientation & Mobility Services')
insert @MAP_ServiceDef values ('AA695BB6-947F-44A8-8AB3-43E1B01B6877', '1B4E85B7-F598-4459-AFE7-3327678E989C') -- 'Parent Counseling and Training')
insert @MAP_ServiceDef values ('829EA69A-629D-4883-B2A1-446E3ED2872D', '2DC4A1B5-1E25-4B48-AAAF-DAA3A7C6D2FD') -- 'Personal Care Services')
...
insert @MAP_ServiceDef values ('9DE4CBF9-BD8D-490C-8E1B-34F5E73DEF11', 'FF86821E-A810-4C91-B8FE-240D96278AAB') -- 'Specialized Instruction')
...
-- select * from ServiceDef  order by Name
-- select * from IEPServiceDef order by deleteddate
