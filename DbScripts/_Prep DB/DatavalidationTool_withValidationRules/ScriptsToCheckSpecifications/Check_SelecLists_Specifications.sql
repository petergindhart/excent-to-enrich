...
UNION
SELECT TYPE,LEGACYSPEDCODE,ENRICHLABEL FROM Datavalidation.Selectlists_LOCAL WHERE TYPE = 'LRE' GROUP BY TYPE,LEGACYSPEDCODE,ENRICHLABEL HAVING COUNT(*)= 1
UNION
SELECT TYPE,LEGACYSPEDCODE,ENRICHLABEL FROM Datavalidation.Selectlists_LOCAL WHERE TYPE = 'SERVICE' GROUP BY TYPE,LEGACYSPEDCODE,ENRICHLABEL HAVING COUNT(*)= 1
UNION
...
SELECT ''SelectLists'',''The field '+@columnname+' is required field.'',Line_No,ISNULL(TYPE,'''')+''|''+ISNULL(SUBTYPE,'''')+''|''+ISNULL(ENRICHID,'''')+''|''+ISNULL(STATECODE,'''')+''|''+ISNULL(LEGACYSPEDCODE,'''')+''|''+ISNULL(EnrichLabel,'''')
...
SET @vsql = 'INSERT Datavalidation.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT ''SelectLists'',''The issue is in the datalength of the field '+@columnname+'.'',Line_No,ISNULL(TYPE,'''')+''|''+ISNULL(SUBTYPE,'''')+''|''+ISNULL(ENRICHID,'''')+''|''+ISNULL(STATECODE,'''')+''|''+ISNULL(LEGACYSPEDCODE,'''')+''|''+ISNULL(EnrichLabel,'''')
FROM Datavalidation.SelectLists_Local WHERE 1 = 1'
...
SELECT 'SelectLists','The SubType is required for Type "LRE".',Line_No,ISNULL(TYPE,'')+'|'+ISNULL(SUBTYPE,'')+'|'+ISNULL(ENRICHID,'')+'|'+ISNULL(STATECODE,'')+'|'+ISNULL(LEGACYSPEDCODE,'')+'|'+ISNULL(EnrichLabel,'')
FROM Datavalidation.Selectlists_LOCAL 
WHERE (TYPE = 'LRE' AND SUBTYPE IS  NULL)

INSERT Datavalidation.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT 'SelectLists','The SubType is required for Type "Service".',Line_No,ISNULL(TYPE,'')+'|'+ISNULL(SUBTYPE,'')+'|'+ISNULL(ENRICHID,'')+'|'+ISNULL(STATECODE,'')+'|'+ISNULL(LEGACYSPEDCODE,'')+'|'+ISNULL(EnrichLabel,'')
FROM Datavalidation.Selectlists_LOCAL 
WHERE (TYPE = 'Service' AND SUBTYPE IS  NULL)


INSERT Datavalidation.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT 'SelectLists','The Given type is not listed in our specifications.',Line_No,ISNULL(TYPE,'')+'|'+ISNULL(SUBTYPE,'')+'|'+ISNULL(ENRICHID,'')+'|'+ISNULL(STATECODE,'')+'|'+ISNULL(LEGACYSPEDCODE,'')+'|'+ISNULL(EnrichLabel,'')
FROM Datavalidation.Selectlists_LOCAL 
...
-----------------------------------------------------------------------------------
INSERT Datavalidation.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT 'SelectLists','The Race record is duplicated.',tsl.Line_No,ISNULL(tsl.TYPE,'')+'|'+ISNULL(tsl.SUBTYPE,'')+'|'+ISNULL(tsl.ENRICHID,'')+'|'+ISNULL(tsl.STATECODE,'')+'|'+ISNULL(tsl.LEGACYSPEDCODE,'')+'|'+ISNULL(tsl.ENRICHLABEL,'')
...
INSERT Datavalidation.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT 'SelectLists','The Gender record is duplicated.',tsl.Line_No,ISNULL(tsl.TYPE,'')+'|'+ISNULL(tsl.SUBTYPE,'')+'|'+ISNULL(tsl.ENRICHID,'')+'|'+ISNULL(tsl.STATECODE,'')+'|'+ISNULL(tsl.LEGACYSPEDCODE,'')+'|'+ISNULL(tsl.ENRICHLABEL,'')
FROM Datavalidation.Selectlists_LOCAL tsl
...
INSERT Datavalidation.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT 'SelectLists','The Grade record is duplicated.',tsl.Line_No,ISNULL(tsl.TYPE,'')+'|'+ISNULL(tsl.SUBTYPE,'')+'|'+ISNULL(tsl.ENRICHID,'')+'|'+ISNULL(tsl.STATECODE,'')+'|'+ISNULL(tsl.LEGACYSPEDCODE,'')+'|'+ISNULL(tsl.ENRICHLABEL,'')
FROM Datavalidation.Selectlists_LOCAL tsl
...
INSERT Datavalidation.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT 'SelectLists','The "Disability" record is duplicated.',tsl.Line_No,ISNULL(tsl.TYPE,'')+'|'+ISNULL(tsl.SUBTYPE,'')+'|'+ISNULL(tsl.ENRICHID,'')+'|'+ISNULL(tsl.STATECODE,'')+'|'+ISNULL(tsl.LEGACYSPEDCODE,'')+'|'+ISNULL(tsl.ENRICHLABEL,'')
FROM Datavalidation.Selectlists_LOCAL tsl
...
INSERT Datavalidation.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT 'SelectLists','The "Exit" record is duplicated.',tsl.Line_No,ISNULL(tsl.TYPE,'')+'|'+ISNULL(tsl.SUBTYPE,'')+'|'+ISNULL(tsl.ENRICHID,'')+'|'+ISNULL(tsl.STATECODE,'')+'|'+ISNULL(tsl.LEGACYSPEDCODE,'')+'|'+ISNULL(tsl.ENRICHLABEL,'')
FROM Datavalidation.Selectlists_LOCAL tsl
...
INSERT Datavalidation.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT 'SelectLists','The "LRE" record is duplicated.',tsl.Line_No,ISNULL(tsl.TYPE,'')+'|'+ISNULL(tsl.SUBTYPE,'')+'|'+ISNULL(tsl.ENRICHID,'')+'|'+ISNULL(tsl.STATECODE,'')+'|'+ISNULL(tsl.LEGACYSPEDCODE,'')+'|'+ISNULL(tsl.ENRICHLABEL,'')
FROM Datavalidation.Selectlists_LOCAL tsl
...
INSERT Datavalidation.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT 'SelectLists','The "Service" record is duplicated.',tsl.Line_No,ISNULL(tsl.TYPE,'')+'|'+ISNULL(tsl.SUBTYPE,'')+'|'+ISNULL(tsl.ENRICHID,'')+'|'+ISNULL(tsl.STATECODE,'')+'|'+ISNULL(tsl.LEGACYSPEDCODE,'')+'|'+ISNULL(tsl.ENRICHLABEL,'')
FROM Datavalidation.Selectlists_LOCAL tsl
...
INSERT Datavalidation.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT 'SelectLists','The "ServLoc" record is duplicated.',tsl.Line_No,ISNULL(tsl.TYPE,'')+'|'+ISNULL(tsl.SUBTYPE,'')+'|'+ISNULL(tsl.ENRICHID,'')+'|'+ISNULL(tsl.STATECODE,'')+'|'+ISNULL(tsl.LEGACYSPEDCODE,'')+'|'+ISNULL(tsl.ENRICHLABEL,'')
FROM Datavalidation.Selectlists_LOCAL tsl
...
INSERT Datavalidation.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT 'SelectLists','The "ServProv" record is duplicated.',tsl.Line_No,ISNULL(tsl.TYPE,'')+'|'+ISNULL(tsl.SUBTYPE,'')+'|'+ISNULL(tsl.ENRICHID,'')+'|'+ISNULL(tsl.STATECODE,'')+'|'+ISNULL(tsl.LEGACYSPEDCODE,'')+'|'+ISNULL(tsl.ENRICHLABEL,'')
FROM Datavalidation.Selectlists_LOCAL tsl
...
INSERT Datavalidation.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT 'SelectLists','The "ServFreq" record is duplicated.',tsl.Line_No,ISNULL(tsl.TYPE,'')+'|'+ISNULL(tsl.SUBTYPE,'')+'|'+ISNULL(tsl.ENRICHID,'')+'|'+ISNULL(tsl.STATECODE,'')+'|'+ISNULL(tsl.LEGACYSPEDCODE,'')+'|'+ISNULL(tsl.ENRICHLABEL,'')
FROM Datavalidation.Selectlists_LOCAL tsl
...
INSERT Datavalidation.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT 'SelectLists','The "GoalArea" record is duplicated.',tsl.Line_No,ISNULL(tsl.TYPE,'')+'|'+ISNULL(tsl.SUBTYPE,'')+'|'+ISNULL(tsl.ENRICHID,'')+'|'+ISNULL(tsl.STATECODE,'')+'|'+ISNULL(tsl.LEGACYSPEDCODE,'')+'|'+ISNULL(tsl.ENRICHLABEL,'')
FROM Datavalidation.Selectlists_LOCAL tsl
...
INSERT Datavalidation.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT 'SelectLists','The "PostSchArea" record is duplicated.',tsl.Line_No,ISNULL(tsl.TYPE,'')+'|'+ISNULL(tsl.SUBTYPE,'')+'|'+ISNULL(tsl.ENRICHID,'')+'|'+ISNULL(tsl.STATECODE,'')+'|'+ISNULL(tsl.LEGACYSPEDCODE,'')+'|'+ISNULL(tsl.ENRICHLABEL,'')
FROM Datavalidation.Selectlists_LOCAL tsl
