IF  EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'x_LEGACYGIFT.Transform_Schedule_Function'))
DROP FUNCTION x_LEGACYGIFT.Transform_Schedule_Function
GO

CREATE FUNCTION x_LEGACYGIFT.Transform_Schedule_Function ()  
	RETURNS @s table(
