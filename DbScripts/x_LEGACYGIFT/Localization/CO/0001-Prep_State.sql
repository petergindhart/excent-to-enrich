...
--IF EXISTS (SELECT * FROM sys.schemas s join sys.objects o on s.schema_id = o.schema_id WHERE s.name = 'x_LEGACYGIFT' and o.Name ='DistrictSchoolLeadingZeros' and type = 'U')
--drop table x_LEGACYGIFT.DistrictSchoolLeadingZeros
--GO

--CREATE TABLE x_LEGACYGIFT.DistrictSchoolLeadingZeros
--(
...
--insert x_LEGACYGIFT.DistrictSchoolLeadingZeros values ('District', '00000')
--insert x_LEGACYGIFT.DistrictSchoolLeadingZeros values ('School', '00000')
--go
...
--	x_LEGACYGIFT.MAP_IepDisability is populated with ETL from legacy data.  Legacy data must have the StateCode.
...
--IF NOT EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'x_LEGACYGIFT.MAP_FederalRace') AND OBJECTPROPERTY(id, N'IsUserTable') = 1)
--BEGIN
--create table x_LEGACYGIFT.MAP_FederalRace 
--	(
--	StateRaceCode varchar(150) NOT NULL,
--	FederalRaceName varchar(150) NOT NULL
--	)
--ALTER TABLE x_LEGACYGIFT.MAP_FederalRace ADD CONSTRAINT
...
----insert x_LEGACYGIFT.MAP_FederalRace values ('A', 'Asian')
----insert x_LEGACYGIFT.MAP_FederalRace values ('I', 'American Indian')
----insert x_LEGACYGIFT.MAP_FederalRace values ('P', 'Hawaiian Pacific Islander')
----insert x_LEGACYGIFT.MAP_FederalRace values ('H', 'Hispanic')
----insert x_LEGACYGIFT.MAP_FederalRace values ('W', 'White')
----insert x_LEGACYGIFT.MAP_FederalRace values ('B', 'Black African American')
--go

---- #############################################################################
----		Goal Area Def MAP

--IF EXISTS (SELECT * FROM sys.objects WHERE Name = 'x_LEGACYGIFT.MAP_GoalAreaDefID')
...
--insert x_LEGACYGIFT.MAP_IepGoalAreaDefID values ('ZZZ', 'FED37909-91FF-43F6-8772-C7D5513F1A01')
