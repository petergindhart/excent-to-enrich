...
insert @MAP_ServiceDef values ('52AD0E2D-3A97-499A-95F4-5B4BB02912DF', 'B4F8BB64-97D1-405B-90FE-53DA999B1E21') -- 'Adapted Physical Education')
insert @MAP_ServiceDef values ('6C1EA4EC-C0F0-4C7D-99F2-7AFBB2DBB68C', 'B8531A20-9E68-4885-96EE-6BC1649E5454') -- 'Audiology Services')
	--insert @MAP_ServiceDef values ('61D1B5E8-C054-4EA8-B9CB-F61EBDB1F629', '54AD7B8C-D44B-45C2-9C80-7BBF87579AB4') -- 'Consultation')
insert @MAP_ServiceDef values ('94C0C353-6595-4A7E-873E-CE77A52474FA', 'C8831467-7B27-406B-820E-23281BAA2A36') -- 'Counseling')
insert @MAP_ServiceDef values ('E3A7E8E5-72C4-4871-8381-E081EC81D1D6', '6998A034-4634-44B7-B09D-A080DC6BA48F') -- 'Interpreting Services')
--insert @MAP_ServiceDef values ('B874A136-2F0E-4955-AA1E-1F0D45F263FB', '') -- 'Occupational Therapy')
insert @MAP_ServiceDef values ('CABB2C1E-BC93-4D52-9E2D-AF52A259AD17', 'AA88AA1C-1D0C-4B04-979A-0E0FBBD444CC') -- 'Orientation & Mobility Services')
insert @MAP_ServiceDef values ('AA695BB6-947F-44A8-8AB3-43E1B01B6877', '58CA8D08-FF3B-40AA-A5E2-99604E99DF00') -- 'Parent Counseling and Training')
insert @MAP_ServiceDef values ('829EA69A-629D-4883-B2A1-446E3ED2872D', '132254EB-B85E-4FB0-9D57-1FC0398A61E5') -- 'Personal Care Services')
...
insert @MAP_ServiceDef values ('9DE4CBF9-BD8D-490C-8E1B-34F5E73DEF11', '3C041FE1-8D52-430C-B0E6-D5846120B632') -- 'Specialized Instruction')
...
-- select * from ServiceDef order by deleteddate
...
--Violation of PRIMARY KEY constraint 'PK_IepServiceDef'. Cannot insert duplicate key in object 'dbo.IepServiceDef'.
--The statement has been terminated.

--Msg 547, Level 16, State 0, Line 178
--The DELETE statement conflicted with the REFERENCE constraint "FK_IepServiceDef_ServiceDef". The conflict occurred in database "Enrich_DCB4_CO_SLV", table "dbo.IepServiceDef", column 'ID'.
--The statement has been terminated.
