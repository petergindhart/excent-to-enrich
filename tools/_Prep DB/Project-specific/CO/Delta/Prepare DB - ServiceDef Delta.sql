...
insert @MAP_ServiceDef values ('52AD0E2D-3A97-499A-95F4-5B4BB02912DF', 'C572E212-014C-4EA8-94F3-ABD05423BA0F') -- 'Adapted Physical Education')
insert @MAP_ServiceDef values ('6C1EA4EC-C0F0-4C7D-99F2-7AFBB2DBB68C', '71B01189-E21D-4F3F-8160-84062FBA6BFC') -- 'Audiology Services')
	--insert @MAP_ServiceDef values ('61D1B5E8-C054-4EA8-B9CB-F61EBDB1F629', '54AD7B8C-D44B-45C2-9C80-7BBF87579AB4') -- 'Consultation')
insert @MAP_ServiceDef values ('94C0C353-6595-4A7E-873E-CE77A52474FA', 'A445995C-65C1-4106-A776-858EB3F3B915') -- 'Counseling')
insert @MAP_ServiceDef values ('E3A7E8E5-72C4-4871-8381-E081EC81D1D6', 'CBB3C5A0-0E27-49CC-8BC0-34E673A87C98') -- 'Interpreting Services')
--insert @MAP_ServiceDef values ('B874A136-2F0E-4955-AA1E-1F0D45F263FB', '') -- 'Occupational Therapy')
insert @MAP_ServiceDef values ('CABB2C1E-BC93-4D52-9E2D-AF52A259AD17', '3AC72E11-FDFF-4839-BFBE-A552A7AED1D8') -- 'Orientation & Mobility Services')
insert @MAP_ServiceDef values ('AA695BB6-947F-44A8-8AB3-43E1B01B6877', 'C0D5F34C-FF83-4ABA-9D1A-8E6023BE607A') -- 'Parent Counseling and Training')
insert @MAP_ServiceDef values ('829EA69A-629D-4883-B2A1-446E3ED2872D', '4B4B8410-92A7-44F7-95E8-A15D0A96FCCB') -- 'Personal Care Services')
...
insert @MAP_ServiceDef values ('9DE4CBF9-BD8D-490C-8E1B-34F5E73DEF11', '1223C547-EF06-422C-8344-493CB1CB6837') -- 'Specialized Instruction')
