...
delete x
from StudentPhoto sp join 
@delstudents n  on sp.StudentID = n.StudentID   join 
	FileData x on sp.PhotoID = x.ID
...
--Msg 547, Level 16, State 0, Line 307
--The DELETE statement conflicted with the REFERENCE constraint "FK_StudentPhoto#Student#Photos". The conflict occurred in database "Enrich_DCB5_IL_Waukegan", table "dbo.StudentPhoto", column 'StudentID'.
