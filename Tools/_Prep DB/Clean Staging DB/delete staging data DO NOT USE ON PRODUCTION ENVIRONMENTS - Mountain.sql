...
-- begin tran
update ServiceDef set DefaultLocationID = NULL where DefaultLocationID in (select ID from PrgLocation where DeletedDate is not null ) ; 
	--update ServiceDef set DefaultLocationID = NULL where ID = 'B630AE87-E461-4DAC-B5B9-3FB85C78F56D' -- ??????????????????????????????????????
...
delete VC3Deployment.ModuleDependency where UsedBy like '%legacy504%' or Uses like '%legacy504%'
delete VC3Deployment.ModuleDependency where uses = 'speddoc'
delete VC3Deployment.ModuleDependency where UsedBy = 'LEGACYSPED' and Uses = 'x_LEGACYDOC'
delete VC3Deployment.ModuleDependency where UsedBy = 'LEGACYSPED' and Uses = 'x_LEGACYGIFT'
delete VC3Deployment.ModuleDependency where UsedBy = 'x_LEGACYGIFT' and Uses = 'x_LEGACYDOC'
delete VC3Deployment.ModuleDependency where UsedBy = 'LEGACYSPED' and uses = 'x_LEGACY504'


--select * from VC3Deployment.ModuleDependency where uses like '%valid%' or UsedBy like '%valid%'
--select * from VC3Deployment.ModuleDependency where uses like '%LEGACY%' or UsedBy like '%LEGACY%'


update OrgUnit set Number = '1195' where ID = '4BE21F7B-C8B7-4E67-A438-0C54847B437E' and Number is null
update OrgUnit set Number = '3000' where ID = '251A4545-F693-4C69-B852-550B1E4A84F7' and Number is null
update OrgUnit set Number = '1510' where ID = '7FEF1C61-93C8-448D-9129-8FE572FA43FA' and Number is null
update OrgUnit set Number = '2640' where ID = '52830B77-8AB8-4A4C-A0EB-A7DD0D233012' and Number is null
update OrgUnit set Number = '64093' where ID = '6531EF88-352D-4620-AF5D-CE34C54A9F53' and Number is null
