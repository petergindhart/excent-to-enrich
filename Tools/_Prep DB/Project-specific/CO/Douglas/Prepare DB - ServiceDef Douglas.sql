...
-- select ID, Name from ServiceDef order by Name
...
--B874A136-2F0E-4955-AA1E-1F0D45F263FB	Occupational Therapy -- NA
--AD7571AD-BC70-4EB0-8310-83795D6F8602	Orientation and Mobility  -- done
--73107912-4959-4137-910B-B17E52076074	Physical Therapy -- NA
--75D07F63-F586-4C55-8FDE-A5B6D0737157	School Health Services -- NA
--FF86821E-A810-4C91-B8FE-240D96278AAB	Service Plan Development -- NEW
--1278F350-011F-414C-ABCF-22039F5BE85B	Social/Emotional Skills Development -- NEW
--194DFA64-CFF3-4F11-A28C-F56247BDE794	Specialized Instruction -- done
--514DD5F1-891C-48BC-B5D2-10FF8F0F86E7	Speech Language Services -- done
--003CF444-D485-43B9-8508-8D3B7E27FCB4	Transportation -- done
...
update isd 
set CategoryID = x.CategoryID
from @ServiceDef x join 
IepServiceDef isd on x.ID = isd.ID
