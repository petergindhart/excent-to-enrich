...
--	s.Ethnic,
	...
	ESYTBDDate = isnull(convert(varchar, y.ESYTBDDate, 101),''),
...
left join ICESYDetermineTbl y on x.IEPSeqNum = y.IEPComplSeqNum and y.ESYSeqNum = (
	select min(miny.ESYSeqNum)
	from ICESYDetermineTbl miny 
