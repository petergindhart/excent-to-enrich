...
left join excent9710a.ExcentOnlineFL.dbo.NoticeTbl n on x.GStudentID = n.GStudentID and isnull(n.del_flag,0)=0 and n.ConsentDate is not null
	and n.NoticeSeqNum = (
		select max(qmax.NoticeSeqNum) 
		from excent9710a.ExcentOnlineFL.dbo.NoticeTbl qmax 
		...
		and n.ConsentDate = (
			...
			from excent9710a.ExcentOnlineFL.dbo.NoticeTbl nmax
