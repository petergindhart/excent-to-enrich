...
FROM x_DATAVALIDATION.ValidationRules WHERE TableName = 'Student' AND IsRequired =1 AND columnname != 'StudentStateID'
...
FROM x_DATAVALIDATION.ValidationRules WHERE TableName = 'Student' AND columnname != 'StudentStateID'
SET @Count = 1
SET @Txtdatalength = ''
...
DECLARE @TxtPKStudentStateID VARCHAR(MAX)
...
SELECT ''Student'',''The field '+@columnname+' is required but not found.'', COUNT(*)
FROM x_DATAVALIDATION.Student_LOCAL WHERE 1 = 1'
...
----------------------------------------------------------------
IF (1=1 AND @columnname != 'StudentStateID')
BEGIN
...
SET @sumsql = 'INSERT x_DATAVALIDATION.ValidationSummaryReport (TableName,ErrorMessage,NumberOfRecords)
SELECT ''Student'',''No '+@parenttable+' record found for '+@tablename+'.'', COUNT(*)
FROM x_DATAVALIDATION.Student_LOCAL st '
...
SET @vsql = 'INSERT x_DATAVALIDATION.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT ''Student'',''Invalid value in '+@columnname+' it must be Y or N.'',Line_No,ISNULL(CONVERT(VARCHAR(max),StudentRefID),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),StudentLocalID),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),StudentStateID),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),Firstname),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),MiddleName),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),LastName),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),Birthdate),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),Gender),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),MEDICAIDNUMBER),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),GRADELEVELCODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),SERVICEDISTRICTCODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),SERVICESCHOOLCODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),HOMEDISTRICTCODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),HOMESCHOOLCODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ISHISPANIC),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ISAMERICANINDIAN),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ISASIAN),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ISBLACKAFRICANAMERICAN),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ISHAWAIIANPACISLANDER),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ISWHITE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),DISABILITY1CODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),DISABILITY2CODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),DISABILITY3CODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),DISABILITY4CODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),DISABILITY5CODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),DISABILITY6CODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),DISABILITY7CODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),DISABILITY8CODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),DISABILITY9CODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ESYELIG),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ESYTBDDATE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),EXITDATE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),EXITCODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),SPECIALEDSTATUS),'''')
...
SET @sumsql = 'INSERT x_DATAVALIDATION.ValidationSummaryReport (TableName,ErrorMessage,NumberOfRecords)
SELECT ''Student'',''Invalid value in '+@columnname+' it must be Y or N.'', COUNT(*)
FROM x_DATAVALIDATION.Student_LOCAL'
...
SET @vsql = 'INSERT x_DATAVALIDATION.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT ''Student'','''+@columnname+' is duplicated.'',st.Line_No,ISNULL(CONVERT(VARCHAR(max),st.StudentRefID),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.StudentLocalID),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.StudentStateID),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.Firstname),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.MiddleName),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.LastName),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.Birthdate),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.Gender),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.MEDICAIDNUMBER),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.GRADELEVELCODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.SERVICEDISTRICTCODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.SERVICESCHOOLCODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.HOMEDISTRICTCODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.HOMESCHOOLCODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.ISHISPANIC),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.ISAMERICANINDIAN),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.ISASIAN),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.ISBLACKAFRICANAMERICAN),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.ISHAWAIIANPACISLANDER),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.ISWHITE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.DISABILITY1CODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.DISABILITY2CODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.DISABILITY3CODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.DISABILITY4CODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.DISABILITY5CODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.DISABILITY6CODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.DISABILITY7CODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.DISABILITY8CODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.DISABILITY9CODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.ESYELIG),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.ESYTBDDATE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.EXITDATE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.EXITCODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.SPECIALEDSTATUS),'''')
...
SET @sumsql = 'INSERT x_DATAVALIDATION.ValidationSummaryReport (TableName,ErrorMessage,NumberOfRecords)
SELECT ''Student'','''+@columnname+' is duplicated.'', COUNT(*)
FROM x_DATAVALIDATION.Student_LOCAL st JOIN'
...
SET @vsql = 'INSERT x_DATAVALIDATION.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT ''Student'',''No lookup value found for '+@columnname+'.  Contact ExcentDataTeam@excent.com .'',st.Line_No,ISNULL(CONVERT(VARCHAR(max),st.StudentRefID),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.StudentLocalID),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.StudentStateID),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.Firstname),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.MiddleName),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.LastName),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.Birthdate),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.Gender),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.MEDICAIDNUMBER),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.GRADELEVELCODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.SERVICEDISTRICTCODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.SERVICESCHOOLCODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.HOMEDISTRICTCODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.HOMESCHOOLCODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.ISHISPANIC),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.ISAMERICANINDIAN),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.ISASIAN),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.ISBLACKAFRICANAMERICAN),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.ISHAWAIIANPACISLANDER),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.ISWHITE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.DISABILITY1CODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.DISABILITY2CODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.DISABILITY3CODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.DISABILITY4CODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.DISABILITY5CODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.DISABILITY6CODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.DISABILITY7CODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.DISABILITY8CODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.DISABILITY9CODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.ESYELIG),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.ESYTBDDATE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.EXITDATE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.EXITCODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.SPECIALEDSTATUS),'''')
FROM x_DATAVALIDATION.Student_LOCAL st '
...
SET @sumsql = 'INSERT x_DATAVALIDATION.ValidationSummaryReport (TableName,ErrorMessage,NumberOfRecords)
SELECT ''Student'',''No lookup value found for '+@columnname+'.'', COUNT(*)
FROM x_DATAVALIDATION.Student_LOCAL st '
...
SET @sumsql = 'INSERT x_DATAVALIDATION.ValidationSummaryReport (TableName,ErrorMessage,NumberOfRecords)
SELECT ''Student'',''Expected integer value in '+@columnname+'.'', COUNT(*)
...
SET @vsql = 'INSERT x_DATAVALIDATION.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT ''Student'',''Expected date value in '+@columnname+'.'',Line_No,ISNULL(CONVERT(VARCHAR(max),StudentRefID),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),StudentLocalID),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),StudentStateID),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),Firstname),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),MiddleName),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),LastName),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),Birthdate),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),Gender),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),MEDICAIDNUMBER),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),GRADELEVELCODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),SERVICEDISTRICTCODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),SERVICESCHOOLCODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),HOMEDISTRICTCODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),HOMESCHOOLCODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ISHISPANIC),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ISAMERICANINDIAN),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ISASIAN),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ISBLACKAFRICANAMERICAN),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ISHAWAIIANPACISLANDER),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ISWHITE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),DISABILITY1CODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),DISABILITY2CODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),DISABILITY3CODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),DISABILITY4CODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),DISABILITY5CODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),DISABILITY6CODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),DISABILITY7CODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),DISABILITY8CODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),DISABILITY9CODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ESYELIG),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ESYTBDDATE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),EXITDATE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),EXITCODE),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),SPECIALEDSTATUS),'''')  FROM x_DATAVALIDATION.Student_LOCAL WHERE 1 = 1 '
...
SET @sumsql = 'INSERT x_DATAVALIDATION.ValidationSummaryReport (TableName,ErrorMessage,NumberOfRecords)
SELECT ''Student'',''Expected date value in '+@columnname+'.'', COUNT(*)
FROM x_DATAVALIDATION.Student_LOCAL WHERE 1 = 1 '
...
-------------------------------------------------------------------------------------------
-- To make studentstaeid is optional for PK student
-------------------------------------------------------------------------------------------
INSERT x_DATAVALIDATION.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT 'Student','StudentStateID is required.',st.Line_No,ISNULL(convert(varchar(max),st.STUDENTREFID),'')+'|'+ISNULL(convert(varchar(max),st.StudentLocalID),'')+'|'+ISNULL(convert(varchar(max),st.StudentStateID),'')+'|'+ISNULL(convert(varchar(max),st.Firstname),'')+'|'+ISNULL(convert(varchar(max),st.MiddleName),'')+'|'+ISNULL(convert(varchar(max),st.LastName),'')+'|'+ISNULL(convert(varchar(max),st.Birthdate),'')+'|'+ISNULL(convert(varchar(max),st.Gender),'')+'|'+ISNULL(convert(varchar(max),st.MEDICAIDNUMBER),'')+'|'+ISNULL(convert(varchar(max),st.GRADELEVELCODE),'')+'|'+ISNULL(convert(varchar(max),st.SERVICEDISTRICTCODE),'')+'|'+ISNULL(convert(varchar(max),st.SERVICESCHOOLCODE),'')+'|'+ISNULL(convert(varchar(max),st.HOMEDISTRICTCODE),'')+'|'+ISNULL(convert(varchar(max),st.HOMESCHOOLCODE),'')+'|'+ISNULL(convert(varchar(max),st.ISHISPANIC),'')+'|'+ISNULL(convert(varchar(max),st.ISAMERICANINDIAN),'')+'|'+ISNULL(convert(varchar(max),st.ISASIAN),'')+'|'+ISNULL(convert(varchar(max),st.ISBLACKAFRICANAMERICAN),'')+'|'+ISNULL(convert(varchar(max),st.ISHAWAIIANPACISLANDER),'')+'|'+ISNULL(convert(varchar(max),st.ISWHITE),'')+'|'+ISNULL(convert(varchar(max),st.DISABILITY1CODE),'')+'|'+ISNULL(convert(varchar(max),st.DISABILITY2CODE),'')+'|'+ISNULL(convert(varchar(max),st.DISABILITY3CODE),'')+'|'+ISNULL(convert(varchar(max),st.DISABILITY4CODE),'')+'|'+ISNULL(convert(varchar(max),st.DISABILITY5CODE),'')+'|'+ISNULL(convert(varchar(max),st.DISABILITY6CODE),'')+'|'+ISNULL(convert(varchar(max),st.DISABILITY7CODE),'')+'|'+ISNULL(convert(varchar(max),st.DISABILITY8CODE),'')+'|'+ISNULL(convert(varchar(max),st.DISABILITY9CODE),'')+'|'+ISNULL(convert(varchar(max),st.ESYELIG),'')+'|'+ISNULL(convert(varchar(max),st.ESYTBDDATE),'')+'|'+ISNULL(convert(varchar(max),st.EXITDATE),'')+'|'+ISNULL(convert(varchar(max),st.EXITCODE),'')+'|'+ISNULL(convert(varchar(max),st.SPECIALEDSTATUS),'')
FROM x_DATAVALIDATION.Student_LOCAL st
WHERE (st.studentstateid IS NULL AND st.GradelevelCode != 'PK')
--for K12 students

INSERT x_DATAVALIDATION.ValidationSummaryReport (TableName,ErrorMessage,NumberOfRecords)
SELECT 'Student','StudentStateID is required.',COUNT(*)	 
FROM x_DATAVALIDATION.Student_LOCAL st
WHERE (st.studentstateid IS NULL AND st.GradelevelCode != 'PK')
...
-----------------------------------------------------------------
INSERT x_DATAVALIDATION.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT 'Student','The ServiceDistrictCode and ServiceSchoolCode combination does not exist in the School table.',st.Line_No,ISNULL(convert(varchar(max),st.STUDENTREFID),'')+'|'+ISNULL(convert(varchar(max),st.StudentLocalID),'')+'|'+ISNULL(convert(varchar(max),st.StudentStateID),'')+'|'+ISNULL(convert(varchar(max),st.Firstname),'')+'|'+ISNULL(convert(varchar(max),st.MiddleName),'')+'|'+ISNULL(convert(varchar(max),st.LastName),'')+'|'+ISNULL(convert(varchar(max),st.Birthdate),'')+'|'+ISNULL(convert(varchar(max),st.Gender),'')+'|'+ISNULL(convert(varchar(max),st.MEDICAIDNUMBER),'')+'|'+ISNULL(convert(varchar(max),st.GRADELEVELCODE),'')+'|'+ISNULL(convert(varchar(max),st.SERVICEDISTRICTCODE),'')+'|'+ISNULL(convert(varchar(max),st.SERVICESCHOOLCODE),'')+'|'+ISNULL(convert(varchar(max),st.HOMEDISTRICTCODE),'')+'|'+ISNULL(convert(varchar(max),st.HOMESCHOOLCODE),'')+'|'+ISNULL(convert(varchar(max),st.ISHISPANIC),'')+'|'+ISNULL(convert(varchar(max),st.ISAMERICANINDIAN),'')+'|'+ISNULL(convert(varchar(max),st.ISASIAN),'')+'|'+ISNULL(convert(varchar(max),st.ISBLACKAFRICANAMERICAN),'')+'|'+ISNULL(convert(varchar(max),st.ISHAWAIIANPACISLANDER),'')+'|'+ISNULL(convert(varchar(max),st.ISWHITE),'')+'|'+ISNULL(convert(varchar(max),st.DISABILITY1CODE),'')+'|'+ISNULL(convert(varchar(max),st.DISABILITY2CODE),'')+'|'+ISNULL(convert(varchar(max),st.DISABILITY3CODE),'')+'|'+ISNULL(convert(varchar(max),st.DISABILITY4CODE),'')+'|'+ISNULL(convert(varchar(max),st.DISABILITY5CODE),'')+'|'+ISNULL(convert(varchar(max),st.DISABILITY6CODE),'')+'|'+ISNULL(convert(varchar(max),st.DISABILITY7CODE),'')+'|'+ISNULL(convert(varchar(max),st.DISABILITY8CODE),'')+'|'+ISNULL(convert(varchar(max),st.DISABILITY9CODE),'')+'|'+ISNULL(convert(varchar(max),st.ESYELIG),'')+'|'+ISNULL(convert(varchar(max),st.ESYTBDDATE),'')+'|'+ISNULL(convert(varchar(max),st.EXITDATE),'')+'|'+ISNULL(convert(varchar(max),st.EXITCODE),'')+'|'+ISNULL(convert(varchar(max),st.SPECIALEDSTATUS),'')
FROM x_DATAVALIDATION.Student_LOCAL st
...
INSERT x_DATAVALIDATION.ValidationSummaryReport (TableName,ErrorMessage,NumberOfRecords)
SELECT 'Student','The ServiceDistrictCode and ServiceSchoolCode combination does not exist in the School table.',COUNT(*)	 
FROM x_DATAVALIDATION.Student_LOCAL st
LEFT JOIN (SELECT STUDENTREFID FROM x_DATAVALIDATION.Student_LOCAL st JOIN x_DATAVALIDATION.School sc ON st.ServiceDistrictCode = sc.DistrictCode AND st.ServiceSchoolCode = sc.SchoolCode) stusersch ON st.STUDENTREFID = stusersch.STUDENTREFID
WHERE stusersch.STUDENTREFID IS NULL
           
INSERT x_DATAVALIDATION.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT 'Student','The HomeDistrictCode and HomeSchoolCode combination does not exist in the School table.',st.Line_No,ISNULL(convert(varchar(max),st.STUDENTREFID),'')+'|'+ISNULL(convert(varchar(max),st.StudentLocalID),'')+'|'+ISNULL(convert(varchar(max),st.StudentStateID),'')+'|'+ISNULL(convert(varchar(max),st.Firstname),'')+'|'+ISNULL(convert(varchar(max),st.MiddleName),'')+'|'+ISNULL(convert(varchar(max),st.LastName),'')+'|'+ISNULL(convert(varchar(max),st.Birthdate),'')+'|'+ISNULL(convert(varchar(max),st.Gender),'')+'|'+ISNULL(convert(varchar(max),st.MEDICAIDNUMBER),'')+'|'+ISNULL(convert(varchar(max),st.GRADELEVELCODE),'')+'|'+ISNULL(convert(varchar(max),st.SERVICEDISTRICTCODE),'')+'|'+ISNULL(convert(varchar(max),st.SERVICESCHOOLCODE),'')+'|'+ISNULL(convert(varchar(max),st.HOMEDISTRICTCODE),'')+'|'+ISNULL(convert(varchar(max),st.HOMESCHOOLCODE),'')+'|'+ISNULL(convert(varchar(max),st.ISHISPANIC),'')+'|'+ISNULL(convert(varchar(max),st.ISAMERICANINDIAN),'')+'|'+ISNULL(convert(varchar(max),st.ISASIAN),'')+'|'+ISNULL(convert(varchar(max),st.ISBLACKAFRICANAMERICAN),'')+'|'+ISNULL(convert(varchar(max),st.ISHAWAIIANPACISLANDER),'')+'|'+ISNULL(convert(varchar(max),st.ISWHITE),'')+'|'+ISNULL(convert(varchar(max),st.DISABILITY1CODE),'')+'|'+ISNULL(convert(varchar(max),st.DISABILITY2CODE),'')+'|'+ISNULL(convert(varchar(max),st.DISABILITY3CODE),'')+'|'+ISNULL(convert(varchar(max),st.DISABILITY4CODE),'')+'|'+ISNULL(convert(varchar(max),st.DISABILITY5CODE),'')+'|'+ISNULL(convert(varchar(max),st.DISABILITY6CODE),'')+'|'+ISNULL(convert(varchar(max),st.DISABILITY7CODE),'')+'|'+ISNULL(convert(varchar(max),st.DISABILITY8CODE),'')+'|'+ISNULL(convert(varchar(max),st.DISABILITY9CODE),'')+'|'+ISNULL(convert(varchar(max),st.ESYELIG),'')+'|'+ISNULL(convert(varchar(max),st.ESYTBDDATE),'')+'|'+ISNULL(convert(varchar(max),st.EXITDATE),'')+'|'+ISNULL(convert(varchar(max),st.EXITCODE),'')+'|'+ISNULL(convert(varchar(max),st.SPECIALEDSTATUS),'')
FROM x_DATAVALIDATION.Student_LOCAL st
...
INSERT x_DATAVALIDATION.ValidationSummaryReport (TableName,ErrorMessage,NumberOfRecords)
SELECT 'Student','The HomeDistrictCode and HomeSchoolCode combination does not exist in the School table.',COUNT(*)	 
FROM x_DATAVALIDATION.Student_LOCAL st
LEFT JOIN (SELECT STUDENTREFID FROM x_DATAVALIDATION.Student_LOCAL st JOIN x_DATAVALIDATION.School sc ON st.HomeDistrictCode = sc.DistrictCode AND st.HomeSchoolCode = sc.SchoolCode) stuhomsch ON st.STUDENTREFID = stuhomsch.STUDENTREFID
WHERE stuhomsch.STUDENTREFID IS NULL
/*
