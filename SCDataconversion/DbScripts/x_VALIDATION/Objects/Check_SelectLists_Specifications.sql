...
SELECT ''SelectLists'','''+@columnname+' is required but not found.'', COUNT(*)
FROM x_DATAVALIDATION.SelectLists_Local WHERE 1 = 1'
...
SELECT 'SelectLists','SubType is required for Type "LRE". Contact ExcentDataTeam@excent.com',Line_No,ISNULL(CONVERT(VARCHAR(MAX),TYPE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),SUBTYPE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),ENRICHID),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),STATECODE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),LEGACYSPEDCODE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),EnrichLabel),'')
FROM x_DATAVALIDATION.Selectlists_LOCAL 
WHERE (TYPE = 'LRE' AND SUBTYPE IS  NULL)

INSERT x_DATAVALIDATION.ValidationSummaryReport (TableName,ErrorMessage,NumberOfRecords)
SELECT 'SelectLists','SubType is required for Type "LRE".',COUNT(*)
FROM x_DATAVALIDATION.SelectLists_Local
WHERE (TYPE = 'LRE' AND SUBTYPE IS  NULL)

INSERT x_DATAVALIDATION.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT 'SelectLists','SubType is required for Type "Service".   Contact ExcentDataTeam@excent.com',Line_No,ISNULL(CONVERT(VARCHAR(MAX),TYPE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),SUBTYPE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),ENRICHID),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),STATECODE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),LEGACYSPEDCODE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),EnrichLabel),'')
FROM x_DATAVALIDATION.Selectlists_LOCAL 
WHERE (TYPE = 'Service' AND SUBTYPE IS  NULL)

INSERT x_DATAVALIDATION.ValidationSummaryReport (TableName,ErrorMessage,NumberOfRecords)
SELECT 'SelectLists','SubType is required for Type "Service".',COUNT(*)
FROM x_DATAVALIDATION.SelectLists_Local
WHERE (TYPE = 'Service' AND SUBTYPE IS  NULL)

INSERT x_DATAVALIDATION.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT 'SelectLists','The Type is not valid.  Contact ExcentDataTeam@excent.com .',Line_No,ISNULL(CONVERT(VARCHAR(MAX),TYPE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),SUBTYPE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),ENRICHID),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),STATECODE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),LEGACYSPEDCODE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),EnrichLabel),'')
FROM x_DATAVALIDATION.Selectlists_LOCAL 
WHERE TYPE NOT IN ('Ethnic','Grade','Gender','Disab','Exit','LRE','Service','ServLoc','ServProv','ServFreq','GoalArea','PostSchArea')

INSERT x_DATAVALIDATION.ValidationSummaryReport (TableName,ErrorMessage,NumberOfRecords)
SELECT 'SelectLists','The Type is not valid.',COUNT(*)
FROM x_DATAVALIDATION.SelectLists_Local
WHERE TYPE NOT IN ('Ethnic','Grade','Gender','Disab','Exit','LRE','Service','ServLoc','ServProv','ServFreq','GoalArea','PostSchArea')
...
-----------------------------------------------------------------------------------
INSERT x_DATAVALIDATION.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT 'SelectLists','The Race record "'+CONVERT(VARCHAR(MAX),tsl.ENRICHLABEL)+'" is duplicated.  Contact ExcentDataTeam@excent.com .',tsl.Line_No,ISNULL(CONVERT(VARCHAR(MAX),tsl.TYPE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.SUBTYPE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.ENRICHID),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.STATECODE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.LEGACYSPEDCODE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.ENRICHLABEL),'')
FROM x_DATAVALIDATION.Selectlists_LOCAL tsl
JOIN (SELECT TYPE,ENRICHLABEL FROM x_DATAVALIDATION.Selectlists_LOCAL WHERE TYPE = 'Ethnic' GROUP BY TYPE,ENRICHLABEL HAVING COUNT(*)>1) uceth ON ISNULL(uceth.TYPE,'x') = ISNULL(tsl.TYPE,'y')  AND ISNULL(uceth.ENRICHLABEL,'a') = ISNULL(tsl.EnrichLabel,'s')

/*
INSERT x_DATAVALIDATION.ValidationSummaryReport (TableName,ErrorMessage,NumberOfRecords)
SELECT  'SelectLists','The Race record '+CONVERT(VARCHAR(MAX),tsl.ENRICHLABEL)+' is duplicated.',COUNT(*)
FROM x_DATAVALIDATION.Selectlists_LOCAL tsl
JOIN (SELECT TYPE,LEGACYSPEDCODE,ENRICHLABEL FROM x_DATAVALIDATION.Selectlists_LOCAL WHERE TYPE = 'Ethnic' GROUP BY TYPE,ENRICHLABEL HAVING COUNT(*)>1) uceth ON ISNULL(uceth.TYPE,'x') = ISNULL(tsl.TYPE,'y') AND ISNULL(uceth.LEGACYSPEDCODE,'a') = ISNULL(tsl.LEGACYSPEDCODE,'b')  AND ISNULL(uceth.ENRICHLABEL,'a') = ISNULL(tsl.EnrichLabel,'s')
*/

INSERT x_DATAVALIDATION.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT 'SelectLists','The Gender record "'+CONVERT(VARCHAR(MAX),tsl.ENRICHLABEL)+'" is duplicated.  Contact ExcentDataTeam@excent.com .',tsl.Line_No,ISNULL(CONVERT(VARCHAR(MAX),tsl.TYPE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.SUBTYPE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.ENRICHID),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.STATECODE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.LEGACYSPEDCODE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.ENRICHLABEL),'')
FROM x_DATAVALIDATION.Selectlists_LOCAL tsl
JOIN (SELECT TYPE,ENRICHLABEL FROM x_DATAVALIDATION.Selectlists_LOCAL WHERE TYPE = 'Gender' GROUP BY TYPE,ENRICHLABEL HAVING COUNT(*)>1) ucgen ON ISNULL(ucgen.TYPE,'x') = ISNULL(tsl.TYPE,'y') AND ISNULL(ucgen.ENRICHLABEL,'a') = ISNULL(tsl.EnrichLabel,'s')

/*
INSERT x_DATAVALIDATION.ValidationSummaryReport (TableName,ErrorMessage,NumberOfRecords)
SELECT 'SelectLists','The Gender record '+CONVERT(VARCHAR(MAX),tsl.ENRICHLABEL)+' is duplicated.',COUNT(*)
FROM x_DATAVALIDATION.Selectlists_LOCAL tsl
JOIN (SELECT TYPE,LEGACYSPEDCODE,ENRICHLABEL FROM x_DATAVALIDATION.Selectlists_LOCAL WHERE TYPE = 'Gender' GROUP BY TYPE,ENRICHLABEL HAVING COUNT(*)>1) ucgen ON ISNULL(ucgen.TYPE,'x') = ISNULL(tsl.TYPE,'y') AND ISNULL(ucgen.LEGACYSPEDCODE,'a') = ISNULL(tsl.LEGACYSPEDCODE,'b')  AND ISNULL(ucgen.ENRICHLABEL,'a') = ISNULL(tsl.EnrichLabel,'s')
*/

INSERT x_DATAVALIDATION.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT 'SelectLists','The Grade record "'+CONVERT(VARCHAR(MAX),tsl.ENRICHLABEL)+'" is duplicated.  Contact ExcentDataTeam@excent.com .',tsl.Line_No,ISNULL(CONVERT(VARCHAR(MAX),tsl.TYPE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.SUBTYPE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.ENRICHID),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.STATECODE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.LEGACYSPEDCODE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.ENRICHLABEL),'')
FROM x_DATAVALIDATION.Selectlists_LOCAL tsl
JOIN (SELECT TYPE,ENRICHLABEL FROM x_DATAVALIDATION.Selectlists_LOCAL WHERE TYPE = 'Grade' GROUP BY TYPE,ENRICHLABEL HAVING COUNT(*)>1) ucgrad ON ISNULL(ucgrad.TYPE,'x') = ISNULL(tsl.TYPE,'y') AND ISNULL(ucgrad.ENRICHLABEL,'a') = ISNULL(tsl.EnrichLabel,'s')

/*
INSERT x_DATAVALIDATION.ValidationSummaryReport (TableName,ErrorMessage,NumberOfRecords)
SELECT 'SelectLists','The Grade record '+CONVERT(VARCHAR(MAX),tsl.ENRICHLABEL)+' is duplicated.',COUNT(*)
FROM x_DATAVALIDATION.Selectlists_LOCAL tsl
JOIN (SELECT TYPE,LEGACYSPEDCODE,ENRICHLABEL FROM x_DATAVALIDATION.Selectlists_LOCAL WHERE TYPE = 'Grade' GROUP BY TYPE,ENRICHLABEL HAVING COUNT(*)>1) ucgrad ON ISNULL(ucgrad.TYPE,'x') = ISNULL(tsl.TYPE,'y') AND ISNULL(ucgrad.LEGACYSPEDCODE,'a') = ISNULL(tsl.LEGACYSPEDCODE,'b')  AND ISNULL(ucgrad.ENRICHLABEL,'a') = ISNULL(tsl.EnrichLabel,'s')
*/

INSERT x_DATAVALIDATION.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT 'SelectLists','The "Disability" record "'+CONVERT(VARCHAR(MAX),tsl.ENRICHLABEL)+'" is duplicated.  Contact ExcentDataTeam@excent.com .',tsl.Line_No,ISNULL(CONVERT(VARCHAR(MAX),tsl.TYPE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.SUBTYPE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.ENRICHID),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.STATECODE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.LEGACYSPEDCODE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.ENRICHLABEL),'')
FROM x_DATAVALIDATION.Selectlists_LOCAL tsl
JOIN (SELECT TYPE,ENRICHLABEL FROM x_DATAVALIDATION.Selectlists_LOCAL WHERE TYPE = 'Disab' GROUP BY TYPE,ENRICHLABEL HAVING COUNT(*)>1) ucdisab ON ISNULL(ucdisab.TYPE,'x') = ISNULL(tsl.TYPE,'y') AND ISNULL(ucdisab.ENRICHLABEL,'a') = ISNULL(tsl.EnrichLabel,'s')

/*
INSERT x_DATAVALIDATION.ValidationSummaryReport (TableName,ErrorMessage,NumberOfRecords)
SELECT 'SelectLists','The "Disability" record "'+CONVERT(VARCHAR(MAX),tsl.ENRICHLABEL)+'" is duplicated.',COUNT(*)
FROM x_DATAVALIDATION.Selectlists_LOCAL tsl
JOIN (SELECT TYPE,LEGACYSPEDCODE,ENRICHLABEL FROM x_DATAVALIDATION.Selectlists_LOCAL WHERE TYPE = 'Disab' GROUP BY TYPE,ENRICHLABEL HAVING COUNT(*)>1) ucdisab ON ISNULL(ucdisab.TYPE,'x') = ISNULL(tsl.TYPE,'y') AND ISNULL(ucdisab.LEGACYSPEDCODE,'a') = ISNULL(tsl.LEGACYSPEDCODE,'b')  AND ISNULL(ucdisab.ENRICHLABEL,'a') = ISNULL(tsl.EnrichLabel,'s')
*/
INSERT x_DATAVALIDATION.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT 'SelectLists','The "Exit" record "'+CONVERT(VARCHAR(MAX),tsl.ENRICHLABEL)+'" is duplicated.  Contact ExcentDataTeam@excent.com .',tsl.Line_No,ISNULL(CONVERT(VARCHAR(MAX),tsl.TYPE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.SUBTYPE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.ENRICHID),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.STATECODE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.LEGACYSPEDCODE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.ENRICHLABEL),'')
FROM x_DATAVALIDATION.Selectlists_LOCAL tsl
JOIN (SELECT TYPE,ENRICHLABEL FROM x_DATAVALIDATION.Selectlists_LOCAL WHERE TYPE = 'Exit' GROUP BY TYPE,ENRICHLABEL HAVING COUNT(*)>1) ucex ON ISNULL(ucex.TYPE,'x') = ISNULL(tsl.TYPE,'y') AND ISNULL(ucex.ENRICHLABEL,'a') = ISNULL(tsl.EnrichLabel,'s')
/*
INSERT x_DATAVALIDATION.ValidationSummaryReport (TableName,ErrorMessage,NumberOfRecords)
SELECT 'SelectLists','The "Exit" record "'+CONVERT(VARCHAR(MAX),tsl.ENRICHLABEL)+'" is duplicated.',COUNT(*)
FROM x_DATAVALIDATION.Selectlists_LOCAL tsl
...
*/
INSERT x_DATAVALIDATION.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT 'SelectLists','The "LRE" record "'+CONVERT(VARCHAR(MAX),tsl.ENRICHLABEL)+'" is duplicated.  Contact ExcentDataTeam@excent.com .',tsl.Line_No,ISNULL(CONVERT(VARCHAR(MAX),tsl.TYPE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.SUBTYPE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.ENRICHID),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.STATECODE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.LEGACYSPEDCODE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.ENRICHLABEL),'')
FROM x_DATAVALIDATION.Selectlists_LOCAL tsl
JOIN (SELECT TYPE,SubType,ENRICHLABEL FROM x_DATAVALIDATION.Selectlists_LOCAL WHERE TYPE = 'LRE' GROUP BY TYPE,SubType,ENRICHLABEL HAVING COUNT(*)>1) uclre ON ISNULL(uclre.TYPE,'x') = ISNULL(tsl.TYPE,'y') AND ISNULL(uclre.SubType,'a') = ISNULL(tsl.SubType,'b')  AND ISNULL(uclre.ENRICHLABEL,'a') = ISNULL(tsl.EnrichLabel,'s')

/*
INSERT x_DATAVALIDATION.ValidationSummaryReport (TableName,ErrorMessage,NumberOfRecords)
SELECT 'SelectLists','The "LRE" record "'+CONVERT(VARCHAR(MAX),tsl.ENRICHLABEL)+'" is duplicated.',COUNT(*)
FROM x_DATAVALIDATION.Selectlists_LOCAL tsl
JOIN (SELECT TYPE,LEGACYSPEDCODE,ENRICHLABEL FROM x_DATAVALIDATION.Selectlists_LOCAL WHERE TYPE = 'LRE' GROUP BY TYPE,SubType,ENRICHLABEL HAVING COUNT(*)>1) uclre ON ISNULL(uclre.TYPE,'x') = ISNULL(tsl.TYPE,'y') AND ISNULL(uclre.LEGACYSPEDCODE,'a') = ISNULL(tsl.LEGACYSPEDCODE,'b')  AND ISNULL(uclre.ENRICHLABEL,'a') = ISNULL(tsl.EnrichLabel,'s')
*/
INSERT x_DATAVALIDATION.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT 'SelectLists','The "Service" record "'+CONVERT(VARCHAR(MAX),tsl.ENRICHLABEL)+'" is duplicated.  Contact ExcentDataTeam@excent.com .',tsl.Line_No,ISNULL(CONVERT(VARCHAR(MAX),tsl.TYPE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.SUBTYPE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.ENRICHID),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.STATECODE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.LEGACYSPEDCODE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.ENRICHLABEL),'')
FROM x_DATAVALIDATION.Selectlists_LOCAL tsl
JOIN (SELECT TYPE,SubType,ENRICHLABEL FROM x_DATAVALIDATION.Selectlists_LOCAL WHERE TYPE = 'Service' GROUP BY TYPE,ENRICHLABEL,SubType HAVING COUNT(*)>1) ucser ON ISNULL(ucser.TYPE,'x') = ISNULL(tsl.TYPE,'y') AND ISNULL(ucser.ENRICHLABEL,'a') = ISNULL(tsl.EnrichLabel,'s') AND ISNULL(ucser.SubType,'a') = ISNULL(tsl.SubType,'s')
/*
INSERT x_DATAVALIDATION.ValidationSummaryReport (TableName,ErrorMessage,NumberOfRecords)
SELECT 'SelectLists','The "Service" record "'+CONVERT(VARCHAR(MAX),tsl.ENRICHLABEL)+'" is duplicated.',COUNT(*)
FROM x_DATAVALIDATION.Selectlists_LOCAL tsl
JOIN (SELECT TYPE,SubType,LEGACYSPEDCODE,ENRICHLABEL FROM x_DATAVALIDATION.Selectlists_LOCAL WHERE TYPE = 'Service' GROUP BY TYPE,ENRICHLABEL,SubType HAVING COUNT(*)>1) ucser ON ISNULL(ucser.TYPE,'x') = ISNULL(tsl.TYPE,'y') AND ISNULL(ucser.LEGACYSPEDCODE,'a') = ISNULL(tsl.LEGACYSPEDCODE,'b')  AND ISNULL(ucser.ENRICHLABEL,'a') = ISNULL(tsl.EnrichLabel,'s') AND ISNULL(ucser.SubType,'a') = ISNULL(tsl.SubType,'s')
*/
INSERT x_DATAVALIDATION.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT 'SelectLists','The "ServLoc" record "'+CONVERT(VARCHAR(MAX),tsl.ENRICHLABEL)+'" is duplicated.  Contact ExcentDataTeam@excent.com .',tsl.Line_No,ISNULL(CONVERT(VARCHAR(MAX),tsl.TYPE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.SUBTYPE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.ENRICHID),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.STATECODE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.LEGACYSPEDCODE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.ENRICHLABEL),'')
FROM x_DATAVALIDATION.Selectlists_LOCAL tsl
JOIN (SELECT TYPE,ENRICHLABEL FROM x_DATAVALIDATION.Selectlists_LOCAL WHERE TYPE = 'ServLoc' GROUP BY TYPE,ENRICHLABEL HAVING COUNT(*)>1) ucserloc ON ISNULL(ucserloc.TYPE,'x') = ISNULL(tsl.TYPE,'y')  AND ISNULL(ucserloc.ENRICHLABEL,'a') = ISNULL(tsl.EnrichLabel,'s')

/*
INSERT x_DATAVALIDATION.ValidationSummaryReport (TableName,ErrorMessage,NumberOfRecords)
SELECT 'SelectLists','The "ServLoc" record "'+CONVERT(VARCHAR(MAX),tsl.ENRICHLABEL)+'" is duplicated.',COUNT(*)
FROM x_DATAVALIDATION.Selectlists_LOCAL tsl
JOIN (SELECT TYPE,LEGACYSPEDCODE,ENRICHLABEL FROM x_DATAVALIDATION.Selectlists_LOCAL WHERE TYPE = 'ServLoc' GROUP BY TYPE,ENRICHLABEL HAVING COUNT(*)>1) ucserloc ON ISNULL(ucserloc.TYPE,'x') = ISNULL(tsl.TYPE,'y') AND ISNULL(ucserloc.LEGACYSPEDCODE,'a') = ISNULL(tsl.LEGACYSPEDCODE,'b')  AND ISNULL(ucserloc.ENRICHLABEL,'a') = ISNULL(tsl.EnrichLabel,'s')
*/

INSERT x_DATAVALIDATION.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT 'SelectLists','The "ServProv" record "'+CONVERT(VARCHAR(MAX),tsl.ENRICHLABEL)+'" is duplicated.  Contact ExcentDataTeam@excent.com .',tsl.Line_No,ISNULL(CONVERT(VARCHAR(MAX),tsl.TYPE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.SUBTYPE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.ENRICHID),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.STATECODE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.LEGACYSPEDCODE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.ENRICHLABEL),'')
FROM x_DATAVALIDATION.Selectlists_LOCAL tsl
JOIN (SELECT TYPE,ENRICHLABEL FROM x_DATAVALIDATION.Selectlists_LOCAL WHERE TYPE = 'ServProv' GROUP BY TYPE,ENRICHLABEL HAVING COUNT(*)>1) ucserprov ON ISNULL(ucserprov.TYPE,'x') = ISNULL(tsl.TYPE,'y') AND ISNULL(ucserprov.ENRICHLABEL,'a') = ISNULL(tsl.EnrichLabel,'s')

/*
INSERT x_DATAVALIDATION.ValidationSummaryReport (TableName,ErrorMessage,NumberOfRecords)
SELECT 'SelectLists','The "ServProv" record "'+CONVERT(VARCHAR(MAX),tsl.ENRICHLABEL)+'" is duplicated.',COUNT(*)
FROM x_DATAVALIDATION.Selectlists_LOCAL tsl
JOIN (SELECT TYPE,LEGACYSPEDCODE,ENRICHLABEL FROM x_DATAVALIDATION.Selectlists_LOCAL WHERE TYPE = 'ServProv' GROUP BY TYPE,ENRICHLABEL HAVING COUNT(*)>1) ucserprov ON ISNULL(ucserprov.TYPE,'x') = ISNULL(tsl.TYPE,'y') AND ISNULL(ucserprov.LEGACYSPEDCODE,'a') = ISNULL(tsl.LEGACYSPEDCODE,'b')  AND ISNULL(ucserprov.ENRICHLABEL,'a') = ISNULL(tsl.EnrichLabel,'s')
*/

INSERT x_DATAVALIDATION.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT 'SelectLists','The "ServFreq" record "'+CONVERT(VARCHAR(MAX),tsl.ENRICHLABEL)+'" is duplicated.  Contact ExcentDataTeam@excent.com .',tsl.Line_No,ISNULL(CONVERT(VARCHAR(MAX),tsl.TYPE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.SUBTYPE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.ENRICHID),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.STATECODE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.LEGACYSPEDCODE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.ENRICHLABEL),'')
FROM x_DATAVALIDATION.Selectlists_LOCAL tsl
JOIN (SELECT TYPE,ENRICHLABEL FROM x_DATAVALIDATION.Selectlists_LOCAL WHERE TYPE = 'ServFreq' GROUP BY TYPE,ENRICHLABEL HAVING COUNT(*)>1) ucserfreq ON ISNULL(ucserfreq.TYPE,'x') = ISNULL(tsl.TYPE,'y') AND ISNULL(ucserfreq.ENRICHLABEL,'a') = ISNULL(tsl.EnrichLabel,'s')
/*
INSERT x_DATAVALIDATION.ValidationSummaryReport (TableName,ErrorMessage,NumberOfRecords)
...
FROM x_DATAVALIDATION.Selectlists_LOCAL tsl
JOIN (SELECT TYPE,ENRICHLABEL FROM x_DATAVALIDATION.Selectlists_LOCAL WHERE TYPE = 'GoalArea' GROUP BY TYPE,ENRICHLABEL HAVING COUNT(*)>1) ucgoal ON ISNULL(ucgoal.TYPE,'x') = ISNULL(tsl.TYPE,'y') AND ISNULL(ucgoal.ENRICHLABEL,'a') = ISNULL(tsl.EnrichLabel,'s')
/*
INSERT x_DATAVALIDATION.ValidationSummaryReport (TableName,ErrorMessage,NumberOfRecords)
...
*/
INSERT x_DATAVALIDATION.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT 'SelectLists','The "PostSchArea" record "'+CONVERT(VARCHAR(MAX),tsl.ENRICHLABEL)+'" is duplicated.  Contact ExcentDataTeam@excent.com .',tsl.Line_No,ISNULL(CONVERT(VARCHAR(MAX),tsl.TYPE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.SUBTYPE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.ENRICHID),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.STATECODE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.LEGACYSPEDCODE),'')+'|'+ISNULL(CONVERT(VARCHAR(MAX),tsl.ENRICHLABEL),'')
FROM x_DATAVALIDATION.Selectlists_LOCAL tsl
JOIN (SELECT TYPE,ENRICHLABEL FROM x_DATAVALIDATION.Selectlists_LOCAL WHERE TYPE = 'PostSchArea' GROUP BY TYPE,ENRICHLABEL HAVING COUNT(*)>1) ucpsa ON ISNULL(ucpsa.TYPE,'x') = ISNULL(tsl.TYPE,'y') AND ISNULL(ucpsa.ENRICHLABEL,'a') = ISNULL(tsl.EnrichLabel,'s')
