...
SELECT
	...
	GoalAreaCode = coalesce(kd.Code, kc.Code, 'ZZZ'),   
...
left join CodeDescLook kd on kd.UsageId like 'Banks' and g.BankDesc = kd.LookDesc 
left join CodeDescLook kc on kc.UsageId like 'Banks' and g.GoalCode = kc.code
