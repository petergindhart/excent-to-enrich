...
declare @etlRoot varchar(100), 
	...
	; 
select 	
	@etlRoot='C:\EnrichETL_SC', -- consider setting this dynamically by inserting x_DATAVALIDATION.ParamValues using batch command 
	@district = 'demo', -- for simplicity with the majority of districts, this will be the name of the EO hosted database minus _SC_EO
	...
	@linkedServerAddress = '10.0.1.8\SQLServer2005'
select
...
insert x_DATAVALIDATION.ParamValues values ('vpnYN', 'N')
...
insert x_DATAVALIDATION.ParamValues values ('Check_AccomMod','0')
insert x_DATAVALIDATION.ParamValues values ('Check_AssessAccomm','0')
insert x_DATAVALIDATION.ParamValues values ('Check_ClassroomAccommMod','0')
insert x_DATAVALIDATION.ParamValues values ('Check_District','1')
insert x_DATAVALIDATION.ParamValues values ('Check_Evaluation','0')
insert x_DATAVALIDATION.ParamValues values ('Check_EvaluationAssess','0')
...
insert x_DATAVALIDATION.ParamValues values ('Check_PostSchoolConsider','0')
insert x_DATAVALIDATION.ParamValues values ('Check_PostSchoolStatement','0')
insert x_DATAVALIDATION.ParamValues values ('Check_PresentLevel','0')
insert x_DATAVALIDATION.ParamValues values ('Check_PriorWrittenNotice','0')
...
insert x_DATAVALIDATION.ParamValues values ('Check_SpecialFactors','0')
