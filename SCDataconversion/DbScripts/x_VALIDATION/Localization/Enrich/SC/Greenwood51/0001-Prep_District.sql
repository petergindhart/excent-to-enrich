...
select 	
	...
	@district = 'Greenwood51', -- for simplicity with the majority of districts, this will be the name of the EO hosted database minus _SC_EO
...
select
	...
	@remoteDbPwd = 'hsfe6239', 
	@enrichDataSource='.',
	@enrichDbname = 'Enrich_DCB5_SC_Greenwood51',
	@enrichDbUser = 'sa',
	@enrichDbPwd = 'vc3go!!',
	@ftpUser = 'monicar',
	@ftpPwd = 'mr-7007'
