...
select 	
	...
	@district = 'DistrictName', -- for simplicity with the majority of districts, this will be the name of the EO hosted database minus _SC_EO
...
select
	...
	@remoteDbPwd = 'mboufs82', 
	@enrichDataSource='.',
	@enrichDbname = 'Enrich',
	@enrichDbUser = 'enrich_db_user',
	@enrichDbPwd = '3nr1chDB4m3',
	@ftpUser = 'ftpuser',
	@ftpPwd = 'ftppwd'
