...
LEGACYSPED.SubGoalAreaPivotView sg on ga.GoalRefID = sg.GoalRefID join 
	(
	...
	left join LEGACYSPED.Transform_PrgSubGoalAreaDef msub on msub.DestID = sub.ID   
	where isnull(gadef.StateCode, msub.SubGoalAreaCode) is not null 
