...
select
	...
	DestID = isnull(m.DestID, subgadef.id),
	ParentID = tpg.DestID,
...
left join PrgSubGoalAreaDef subgadef on 
	msubga.SubGoalAreaName = subgadef.Name and
	subgadef.ParentID = tpg.DestID 
	--and 
	--subgadef.DeletedDate is null ------------------------------------- new: gg
