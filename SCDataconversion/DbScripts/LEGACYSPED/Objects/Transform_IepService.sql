...
FROM
	...
	PrgSection sec ON
		...
		sec.DefID = 'F8261D6C-2528-4461-8E28-E70C40C417B2' JOIN --IEP Services
	...
	LEGACYSPED.Transform_ServiceFrequency freq on isnull(v.ServiceFrequencyCode, 'ZZZ') = freq.ServiceFrequencyCode LEFT JOIN 
 	...
 	LEGACYSPED.Transform_ServiceCategory cat on isnull(cat.ServiceCategoryCode,'x') = isnull(v.ServiceType,'y')-- LEFT JOIN
