...
select 	
	...
	@district = 'pickens', -- for simplicity with the majority of districts, this will be the name of the EO hosted database minus _SC_EO
...
select
	...
	@remoteDbPwd = 'qjdfot84', 
	@enrichDbname = 'Enrich_DCB4_SC_Pickens',
	@enrichDbUser = 'sa',
	@enrichDbPwd = 'vc3go!!',
	@ftpUser = 'pickens',
	@ftpPwd = 'm2fwtoj'
