...
SET @vsql = 'INSERT x_DATAVALIDATION.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT ''Service'',''The date format issue is in '+@columnname+'.'',Line_No,ISNULL(CONVERT(VARCHAR(max),ServiceType),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ServiceRefId),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),IepRefId),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ServiceDefinitionCode),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),BeginDate),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),EndDate),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),IsRelated),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),IsDirect),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ExcludesFromGenEd),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ServiceLocationCode),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ServiceProviderTitleCode),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),Sequence),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),IsESY),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ServiceTime),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ServiceFrequencyCode),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ServiceProviderSSN),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),StaffEmail),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ServiceAreaText),'''')  FROM x_DATAVALIDATION.Service_LOCAL ser WHERE 1 = 1 '
...
SELECT 'Service','The Service StartDate does not exist in IEP date range.',Line_No,
ISNULL(CONVERT(VARCHAR(50),ServiceType),'')+'|'+ISNULL(CONVERT(VARCHAR(150),ServiceRefId),'')+'|'+ISNULL(CONVERT(VARCHAR(150),IepRefId),'')+'|'+ISNULL(CONVERT(VARCHAR(150),ServiceDefinitionCode),'')+'|'+ISNULL(CONVERT(VARCHAR(150),BeginDate),'')+'|'+ISNULL(CONVERT(VARCHAR(150),EndDate),'')+'|'+ISNULL(CONVERT(VARCHAR(10),IsRelated),'')+'|'+ISNULL(CONVERT(VARCHAR(10),IsDirect),'')
+'|'+ISNULL(CONVERT(VARCHAR(10),ExcludesFromGenEd),'')+'|'+ISNULL(CONVERT(VARCHAR(150),ServiceLocationCode),'')+'|'+ISNULL(CONVERT(VARCHAR(150),ServiceProviderTitleCode),'')+'|'+ISNULL(CONVERT(VARCHAR(10),Sequence),'')+'|'+ISNULL(CONVERT(VARCHAR(10),IsESY),'')+'|'+ISNULL(CONVERT(VARCHAR(50),ServiceTime),'')+'|'+ISNULL(CONVERT(VARCHAR(150),ServiceFrequencyCode),'')
+'|'+ISNULL(CONVERT(VARCHAR(50),ServiceProviderSSN),'')+'|'+ISNULL(CONVERT(VARCHAR(150),StaffEmail),'')+'|'+ISNULL(CONVERT(VARCHAR(max),ServiceAreaText),'')  FROM x_DATAVALIDATION.Service_LOCAL 
...
INSERT x_DATAVALIDATION.ValidationReport(TableName,ErrorMessage,LineNumber,Line)
SELECT 'Service','The Service EndDate does not exist in IEP date range.',Line_No,
ISNULL(CONVERT(VARCHAR(50),ServiceType),'')+'|'+ISNULL(CONVERT(VARCHAR(150),ServiceRefId),'')+'|'+ISNULL(CONVERT(VARCHAR(150),IepRefId),'')+'|'+ISNULL(CONVERT(VARCHAR(150),ServiceDefinitionCode),'')+'|'+ISNULL(CONVERT(VARCHAR(150),BeginDate),'')+'|'+ISNULL(CONVERT(VARCHAR(150),EndDate),'')+'|'+ISNULL(CONVERT(VARCHAR(10),IsRelated),'')+'|'+ISNULL(CONVERT(VARCHAR(10),IsDirect),'')
+'|'+ISNULL(CONVERT(VARCHAR(10),ExcludesFromGenEd),'')+'|'+ISNULL(CONVERT(VARCHAR(150),ServiceLocationCode),'')+'|'+ISNULL(CONVERT(VARCHAR(150),ServiceProviderTitleCode),'')+'|'+ISNULL(CONVERT(VARCHAR(10),Sequence),'')+'|'+ISNULL(CONVERT(VARCHAR(10),IsESY),'')+'|'+ISNULL(CONVERT(VARCHAR(50),ServiceTime),'')+'|'+ISNULL(CONVERT(VARCHAR(150),ServiceFrequencyCode),'')
+'|'+ISNULL(CONVERT(VARCHAR(50),ServiceProviderSSN),'')+'|'+ISNULL(CONVERT(VARCHAR(150),StaffEmail),'')+'|'+ISNULL(CONVERT(VARCHAR(max),ServiceAreaText),'') FROM x_DATAVALIDATION.Service_LOCAL 
