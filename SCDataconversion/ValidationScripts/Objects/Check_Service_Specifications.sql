...
SET @vsql = 'INSERT x_DATAVALIDATION.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT ''Service'',''The issue is in the datalength of the field '+@columnname+'.'',ser.Line_No,ISNULL(CONVERT(VARCHAR(max),st.studentLocalID),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.FirstName),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.LastName),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceType),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceRefId),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.IepRefId),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceDefinitionCode),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.BeginDate),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.EndDate),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.IsRelated),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.IsDirect),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ExcludesFromGenEd),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceLocationCode),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceProviderTitleCode),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.Sequence),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.IsESY),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceTime),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceFrequencyCode),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceProviderSSN),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.StaffEmail),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceAreaText),'''')
FROM x_DATAVALIDATION.Service_LOCAL ser JOIN x_DATAVALIDATION.IEP_LOCAL iep ON iep.IEPRefID = ser.IEPRefID JOIN x_DATAVALIDATION.Student_LOCAL st ON st.StudentRefID = iep.StudentRefID WHERE 1 = 1 '
...
SET @vsql = 'INSERT x_DATAVALIDATION.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT ''Service'',''The '+@columnname+' ''''''+CONVERT(VARCHAR(MAX),ser.'+@columnname+')+'''''' does not exist in '+@parenttable+'  or were not validated successfully, but it existed in '+@tablename+'.'',ser.Line_No,ISNULL(CONVERT(VARCHAR(max),st.studentLocalID),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.FirstName),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.LastName),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceType),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceRefId),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.IepRefId),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceDefinitionCode),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.BeginDate),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.EndDate),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.IsRelated),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.IsDirect),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ExcludesFromGenEd),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceLocationCode),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceProviderTitleCode),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.Sequence),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.IsESY),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceTime),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceFrequencyCode),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceProviderSSN),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.StaffEmail),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceAreaText),'''')
...
SET @vsql = 'INSERT x_DATAVALIDATION.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT ''Service'',''The field '+@columnname+' should have one of the value in '''+LTRIM(REPLACE(@flagrecords,''',''','/'))+''''',ser.Line_No,ISNULL(CONVERT(VARCHAR(max),st.studentLocalID),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.FirstName),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.LastName),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceType),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceRefId),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.IepRefId),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceDefinitionCode),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.BeginDate),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.EndDate),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.IsRelated),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.IsDirect),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ExcludesFromGenEd),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceLocationCode),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceProviderTitleCode),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.Sequence),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.IsESY),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceTime),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceFrequencyCode),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceProviderSSN),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.StaffEmail),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceAreaText),'''')
FROM x_DATAVALIDATION.Service_LOCAL ser JOIN x_DATAVALIDATION.IEP_LOCAL iep ON iep.IEPRefID = ser.IEPRefID JOIN x_DATAVALIDATION.Student_LOCAL st ON st.StudentRefID = iep.StudentRefID '
...
SET @vsql = 'INSERT x_DATAVALIDATION.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT ''Service'',''The field '+@columnname+' is unique field, Here ''''''+CONVERT(VARCHAR(MAX),ser.'+@columnname+')+'''''' record is repeated.'',ser.Line_No,ISNULL(CONVERT(VARCHAR(max),st.studentLocalID),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.FirstName),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.LastName),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceType),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceRefId),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.IepRefId),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceDefinitionCode),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.BeginDate),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.EndDate),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.IsRelated),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.IsDirect),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ExcludesFromGenEd),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceLocationCode),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceProviderTitleCode),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.Sequence),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.IsESY),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceTime),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceFrequencyCode),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceProviderSSN),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.StaffEmail),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceAreaText),'''') FROM x_DATAVALIDATION.Service_LOCAL ser JOIN x_DATAVALIDATION.IEP_LOCAL iep ON iep.IEPRefID = ser.IEPRefID JOIN x_DATAVALIDATION.Student_LOCAL st ON st.StudentRefID = iep.StudentRefID '
...
SET @vsql = 'INSERT x_DATAVALIDATION.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT ''Service'',''The '+@columnname+' ''''''+ ser.'+@columnname+'+'''''' does not exist in '+@lookuptable+', but it existed in '+@tablename+''',ser.Line_No,ISNULL(CONVERT(VARCHAR(max),st.studentLocalID),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.FirstName),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.LastName),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceType),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceRefId),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.IepRefId),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceDefinitionCode),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.BeginDate),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.EndDate),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.IsRelated),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.IsDirect),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ExcludesFromGenEd),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceLocationCode),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceProviderTitleCode),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.Sequence),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.IsESY),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceTime),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceFrequencyCode),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceProviderSSN),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.StaffEmail),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceAreaText),'''') FROM x_DATAVALIDATION.Service_LOCAL ser JOIN x_DATAVALIDATION.IEP_LOCAL iep ON iep.IEPRefID = ser.IEPRefID JOIN x_DATAVALIDATION.Student_LOCAL st ON st.StudentRefID = iep.StudentRefID '
...
SET @vsql = 'INSERT x_DATAVALIDATION.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT ''Service'',''The date format issue is in '+@columnname+'.'',ser.Line_No,ISNULL(CONVERT(VARCHAR(max),st.studentLocalID),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.FirstName),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.LastName),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceType),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceRefId),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.IepRefId),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceDefinitionCode),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.BeginDate),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.EndDate),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.IsRelated),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.IsDirect),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ExcludesFromGenEd),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceLocationCode),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceProviderTitleCode),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.Sequence),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.IsESY),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceTime),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceFrequencyCode),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceProviderSSN),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.StaffEmail),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceAreaText),'''')
FROM x_DATAVALIDATION.Service_LOCAL ser JOIN x_DATAVALIDATION.IEP_LOCAL iep ON iep.IEPRefID = ser.IEPRefID JOIN x_DATAVALIDATION.Student_LOCAL st ON st.StudentRefID = iep.StudentRefID WHERE 1 = 1 '
...
SET @vsql = 'INSERT x_DATAVALIDATION.ValidationReport (TableName,ErrorMessage,LineNumber,Line)
SELECT ''Service'',''The field '+@columnname+' should have integer records.'',ser.Line_No,ISNULL(CONVERT(VARCHAR(max),st.studentLocalID),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.FirstName),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),st.LastName),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceType),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceRefId),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.IepRefId),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceDefinitionCode),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.BeginDate),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.EndDate),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.IsRelated),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.IsDirect),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ExcludesFromGenEd),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceLocationCode),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceProviderTitleCode),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.Sequence),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.IsESY),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceTime),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceFrequencyCode),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceProviderSSN),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.StaffEmail),'''')+''|''+ISNULL(CONVERT(VARCHAR(max),ser.ServiceAreaText),'''')
FROM x_DATAVALIDATION.Service_LOCAL ser JOIN x_DATAVALIDATION.IEP_LOCAL iep ON iep.IEPRefID = ser.IEPRefID JOIN x_DATAVALIDATION.Student_LOCAL st ON st.StudentRefID = iep.StudentRefID WHERE 1 = 1 '
...
SELECT 'Service','The Service StartDate does not exist in IEP date range.',ser.Line_No,ISNULL(CONVERT(VARCHAR(max),st.studentLocalID),'')+'|'+ISNULL(CONVERT(VARCHAR(max),st.FirstName),'')+'|'+ISNULL(CONVERT(VARCHAR(max),st.LastName),'')+'|'+ISNULL(CONVERT(VARCHAR(50),ServiceType),'')+'|'+ISNULL(CONVERT(VARCHAR(150),ser.ServiceRefId),'')+'|'+ISNULL(CONVERT(VARCHAR(150),ser.IepRefId),'')+'|'+ISNULL(CONVERT(VARCHAR(150),ser.ServiceDefinitionCode),'')+'|'+ISNULL(CONVERT(VARCHAR(150),ser.BeginDate),'')+'|'+ISNULL(CONVERT(VARCHAR(150),ser.EndDate),'')+'|'+ISNULL(CONVERT(VARCHAR(10),ser.IsRelated),'')+'|'+ISNULL(CONVERT(VARCHAR(10),ser.IsDirect),'')+'|'+ISNULL(CONVERT(VARCHAR(10),ser.ExcludesFromGenEd),'')+'|'+ISNULL(CONVERT(VARCHAR(150),ser.ServiceLocationCode),'')+'|'+ISNULL(CONVERT(VARCHAR(150),ser.ServiceProviderTitleCode),'')+'|'+ISNULL(CONVERT(VARCHAR(10),ser.Sequence),'')+'|'+ISNULL(CONVERT(VARCHAR(10),ser.IsESY),'')+'|'+ISNULL(CONVERT(VARCHAR(50),ser.ServiceTime),'')+'|'+ISNULL(CONVERT(VARCHAR(150),ser.ServiceFrequencyCode),'')+'|'+ISNULL(CONVERT(VARCHAR(50),ser.ServiceProviderSSN),'')+'|'+ISNULL(CONVERT(VARCHAR(150),ser.StaffEmail),'')+'|'+ISNULL(CONVERT(VARCHAR(max),ser.ServiceAreaText),'')  
FROM x_DATAVALIDATION.Service_LOCAL ser JOIN x_DATAVALIDATION.IEP_LOCAL iep ON iep.IEPRefID = ser.IEPRefID JOIN x_DATAVALIDATION.Student_LOCAL st ON st.StudentRefID = iep.StudentRefID 
...
INSERT x_DATAVALIDATION.ValidationReport(TableName,ErrorMessage,LineNumber,Line)
SELECT 'Service','The Service EndDate does not exist in IEP date range.',ser.Line_No,ISNULL(CONVERT(VARCHAR(max),st.studentLocalID),'')+'|'+ISNULL(CONVERT(VARCHAR(max),st.FirstName),'')+'|'+ISNULL(CONVERT(VARCHAR(max),st.LastName),'')+'|'+ISNULL(CONVERT(VARCHAR(50),ServiceType),'')+'|'+ISNULL(CONVERT(VARCHAR(150),ser.ServiceRefId),'')+'|'+ISNULL(CONVERT(VARCHAR(150),ser.IepRefId),'')+'|'+ISNULL(CONVERT(VARCHAR(150),ser.ServiceDefinitionCode),'')+'|'+ISNULL(CONVERT(VARCHAR(150),ser.BeginDate),'')+'|'+ISNULL(CONVERT(VARCHAR(150),ser.EndDate),'')+'|'+ISNULL(CONVERT(VARCHAR(10),ser.IsRelated),'')+'|'+ISNULL(CONVERT(VARCHAR(10),ser.IsDirect),'')+'|'+ISNULL(CONVERT(VARCHAR(10),ser.ExcludesFromGenEd),'')+'|'+ISNULL(CONVERT(VARCHAR(150),ser.ServiceLocationCode),'')+'|'+ISNULL(CONVERT(VARCHAR(150),ser.ServiceProviderTitleCode),'')+'|'+ISNULL(CONVERT(VARCHAR(10),ser.Sequence),'')+'|'+ISNULL(CONVERT(VARCHAR(10),ser.IsESY),'')+'|'+ISNULL(CONVERT(VARCHAR(50),ser.ServiceTime),'')+'|'+ISNULL(CONVERT(VARCHAR(150),ser.ServiceFrequencyCode),'')+'|'+ISNULL(CONVERT(VARCHAR(50),ser.ServiceProviderSSN),'')+'|'+ISNULL(CONVERT(VARCHAR(150),ser.StaffEmail),'')+'|'+ISNULL(CONVERT(VARCHAR(max),ser.ServiceAreaText),'')  
FROM x_DATAVALIDATION.Service_LOCAL ser JOIN x_DATAVALIDATION.IEP_LOCAL iep ON iep.IEPRefID = ser.IEPRefID JOIN x_DATAVALIDATION.Student_LOCAL st ON st.StudentRefID = iep.StudentRefID 
