...
-- OrgUnit 
update ou set Number = '0180' -- Aurora Public Schools State Reporting DistrictID
-- select ou.*
...
set nocount on;
insert @Map_ServiceFrequencyID values ('ESY', 'as needed for ESY', 'C559B98D-3AFD-4C84-AF64-AE7EC66461A0')
insert @Map_ServiceFrequencyID values ('ZZZ', 'unknown', 'C42C50ED-863B-44B8-BF68-B377C8B0FA95')
insert @Map_ServiceFrequencyID values ('02', 'monthly', '3D4B557B-0C2E-4A41-9410-BA331F1D20DD')
insert @Map_ServiceFrequencyID values ('D', 'daily', '71590A00-2C40-40FF-ABD9-E73B09AF46A1')
insert @Map_ServiceFrequencyID values ('01', 'weekly', 'A2080478-1A03-4928-905B-ED25DEC259E6')
insert @Map_ServiceFrequencyID values ('03', 'yearly', '5F3A2822-56F3-49DA-9592-F604B0F202C3')
