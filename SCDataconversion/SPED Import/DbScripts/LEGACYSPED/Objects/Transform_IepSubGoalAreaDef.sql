...
--left join dbo.IepSubGoalAreaDef i on ks.EnrichID = i.ID 
--left join dbo.IepSubGoalAreaDef n on ks.EnrichLabel = n.Name 
left join LEGACYSPED.MAP_IepSubGoalAreaDefID m on ks.LegacySpedCode = m.SubGoalAreaCode 
--left join dbo.IepSubGoalAreaDef t on m.DestID = t.ID
